...
{
    public class DbaxDefiPersController
    {
        DbaxDefiPersDAC _goDbaxDefiPersDAC;
        public DbaxDefiPersController()
        { _goDbaxDefiPersDAC = new DbaxDefiPersDAC(); }

        /// <summary>
        /// Metodo para Insertar Registros en el Procedimiento Almacenado S_I_dbax_defi_pers
        /// </summary>
        /// <param name="toDbaxDefiPersBE"></param>
        public void createDbaxDefiPers(DbaxDefiPersBE toDbaxDefiPersBE)
        {
            _goDbaxDefiPersDAC.createDbaxDefiPers(toDbaxDefiPersBE);
        }

        /// <summary>
        /// Método para Obtener Los registros de la tabla dbax_defi_pers, si se va a realizar un select para Mantenedor
        /// </summary>
        ...
        {
            return _goDbaxDefiPersDAC.readDbaxDefiPersList(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        /// <summary>
        /// Metodo para obtener 1 Registro desde la Base de Datos de la Tabla dbax_defi_pers
        /// </summary>
        ...
        {
            return _goDbaxDefiPersDAC.readDbaxDefiPers(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        /// <summary>
        /// Metodo para Actualizar los Datos de la Tabla dbax_defi_pers, todos los parametros se asignan a traves de las BE
        /// </summary>
        /// <param name="toDbaxDefiPersBE"></param>
        public void updateDbaxDefiPers(DbaxDefiPersBE toDbaxDefiPersBE)
        {
            _goDbaxDefiPersDAC.updateDbaxDefiPers(toDbaxDefiPersBE);
        }

        /// <summary>
        /// Método para Eliminar 1 Registro de la tabla dbax_defi_pers
        /// <param name="tnCodiPers"></param>
        /// </summary>
        public void deleteDbaxDefiPers(int tnCodiPers)
        {
            _goDbaxDefiPersDAC.deleteDbaxDefiPers(tnCodiPers);
        }
    }
}