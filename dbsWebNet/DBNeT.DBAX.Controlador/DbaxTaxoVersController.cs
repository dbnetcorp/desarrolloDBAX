...
{
    public class DbaxTaxoVersController
    {
        DbaxTaxoVersDAC _goDbaxTaxoVersDAC;
        public DbaxTaxoVersController()
        { _goDbaxTaxoVersDAC = new DbaxTaxoVersDAC(); }

        /// <summary>
        /// Metodo para Insertar Registros en el Procedimiento Almacenado S_I_dbax_taxo_vers
        /// </summary>
        /// <param name="toDbaxTaxoVersBE"></param>
        public void createDbaxTaxoVers(DbaxTaxoVersBE toDbaxTaxoVersBE)
        {
            _goDbaxTaxoVersDAC.createDbaxTaxoVers(toDbaxTaxoVersBE);
        }

        /// <summary>
        /// Método para Obtener Los registros de la tabla dbax_taxo_vers, si se va a realizar un select para Mantenedor
        /// </summary>
        ...
        {
            return _goDbaxTaxoVersDAC.readDbaxTaxoVersList(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        /// <summary>
        /// Metodo para obtener 1 Registro desde la Base de Datos de la Tabla dbax_taxo_vers
        /// </summary>
        ...
        {
            return _goDbaxTaxoVersDAC.readDbaxTaxoVers(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        public DataTable readDbaxTaxoVersDt(string tsTipo, int tnPagina, int tnRegPag, string tsCondicion, string tsPar1)
        {
            return _goDbaxTaxoVersDAC.readDbaxTaxoVersDt(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1);
        }

        /// <summary>
        /// Metodo para Actualizar los Datos de la Tabla dbax_taxo_vers, todos los parametros se asignan a traves de las BE
        /// </summary>
        /// <param name="toDbaxTaxoVersBE"></param>
        public void updateDbaxTaxoVers(DbaxTaxoVersBE toDbaxTaxoVersBE)
        {
            _goDbaxTaxoVersDAC.updateDbaxTaxoVers(toDbaxTaxoVersBE);
        }

        /// <summary>
        /// Método para Eliminar 1 Registro de la tabla dbax_taxo_vers
        /// <param name="tsVersTaxo"></param>
        /// </summary>
        public void deleteDbaxTaxoVers(string tsVersTaxo)
        {
            _goDbaxTaxoVersDAC.deleteDbaxTaxoVers(tsVersTaxo);
        }
    }
}
