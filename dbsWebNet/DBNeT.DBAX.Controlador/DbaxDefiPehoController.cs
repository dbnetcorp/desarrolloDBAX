...
{
    public class DbaxDefiPehoController
    {
        DbaxDefiPehoDAC _goDbaxDefiPehoDAC;
        public DbaxDefiPehoController()
        { _goDbaxDefiPehoDAC = new DbaxDefiPehoDAC(); }

        /// <summary>
        /// Metodo para Insertar Registros en el Procedimiento Almacenado S_I_dbax_defi_peho
        /// </summary>
        /// <param name="toDbaxDefiPehoBE"></param>
        public void createDbaxDefiPeho(DbaxDefiPehoBE toDbaxDefiPehoBE)
        {
            _goDbaxDefiPehoDAC.createDbaxDefiPeho(toDbaxDefiPehoBE);
        }

        /// <summary>
        /// Método para Obtener Los registros de la tabla dbax_defi_peho, si se va a realizar un select para Mantenedor
        /// </summary>
        ...
        {
            return _goDbaxDefiPehoDAC.readDbaxDefiPehoList(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        /// <summary>
        /// Metodo para obtener 1 Registro desde la Base de Datos de la Tabla dbax_defi_peho
        /// </summary>
        ...
        {
            return _goDbaxDefiPehoDAC.readDbaxDefiPeho(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }
        ...
        {
            return _goDbaxDefiPehoDAC.readDbaxDefiPehoDt(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        /// <summary>
        /// Metodo para Actualizar los Datos de la Tabla dbax_defi_peho, todos los parametros se asignan a traves de las BE
        /// </summary>
        /// <param name="toDbaxDefiPehoBE"></param>
        public void updateDbaxDefiPeho(DbaxDefiPehoBE toDbaxDefiPehoBE)
        {
            _goDbaxDefiPehoDAC.updateDbaxDefiPeho(toDbaxDefiPehoBE);
        }

        /// <summary>
        /// Método para Eliminar 1 Registro de la tabla dbax_defi_peho
        /// <param name="tnCodiPers"></param>
        ...
        {
            _goDbaxDefiPehoDAC.deleteDbaxDefiPeho(tnCodiPers, tsCodiEmex, tnCodiEmpr);
        }
    }
}
