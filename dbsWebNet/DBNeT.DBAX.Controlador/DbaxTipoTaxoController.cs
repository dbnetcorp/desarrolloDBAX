...
{
    public class DbaxTipoTaxoController
    {
        DbaxTipoTaxoDAC _goDbaxTipoTaxoDAC;
        public DbaxTipoTaxoController()
        { _goDbaxTipoTaxoDAC = new DbaxTipoTaxoDAC(); }

        /// <summary>
        /// Metodo para Insertar Registros en el Procedimiento Almacenado S_I_dbax_tipo_taxo
        /// </summary>
        /// <param name="toDbaxTipoTaxoBE"></param>
        public void createDbaxTipoTaxo(DbaxTipoTaxoBE toDbaxTipoTaxoBE)
        {
            _goDbaxTipoTaxoDAC.createDbaxTipoTaxo(toDbaxTipoTaxoBE);
        }

        /// <summary>
        /// Método para Obtener Los registros de la tabla dbax_tipo_taxo, si se va a realizar un select para Mantenedor
        /// </summary>
        ...
        {
            return _goDbaxTipoTaxoDAC.readDbaxTipoTaxoList(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        /// <summary>
        /// Metodo para obtener 1 Registro desde la Base de Datos de la Tabla dbax_tipo_taxo
        /// </summary>
        ...
        {
            return _goDbaxTipoTaxoDAC.readDbaxTipoTaxo(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }
        ...
        {
            return _goDbaxTipoTaxoDAC.readDbaxTipoTaxoDt(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        /// <summary>
        /// Metodo para Actualizar los Datos de la Tabla dbax_tipo_taxo, todos los parametros se asignan a traves de las BE
        /// </summary>
        /// <param name="toDbaxTipoTaxoBE"></param>
        public void updateDbaxTipoTaxo(DbaxTipoTaxoBE toDbaxTipoTaxoBE)
        {
            _goDbaxTipoTaxoDAC.updateDbaxTipoTaxo(toDbaxTipoTaxoBE);
        }

        /// <summary>
        /// Método para Eliminar 1 Registro de la tabla dbax_tipo_taxo
        /// <param name="tsTipoTaxo"></param>
        /// </summary>
        public void deleteDbaxTipoTaxo(string tsTipoTaxo)
        {
            _goDbaxTipoTaxoDAC.deleteDbaxTipoTaxo(tsTipoTaxo);
        }
    }
}
