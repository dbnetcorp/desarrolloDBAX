...
{
    public class DbaxInfoConcController
    {
        DbaxInfoConcDAC _goDbaxInfoConcDAC;
        public DbaxInfoConcController()
        { _goDbaxInfoConcDAC = new DbaxInfoConcDAC(); }

        /// <summary>
        /// Metodo para Insertar Registros en el Procedimiento Almacenado S_I_dbax_info_conc
        /// </summary>
        /// <param name="toDbaxInfoConcBE"></param>
        public void createDbaxInfoConc(DbaxInfoConcBE toDbaxInfoConcBE)
        {
            _goDbaxInfoConcDAC.createDbaxInfoConc(toDbaxInfoConcBE);
        }

        /// <summary>
        /// Método para Obtener Los registros de la tabla dbax_info_conc, si se va a realizar un select para Mantenedor
        /// </summary>
        ...
        {
            return _goDbaxInfoConcDAC.readDbaxInfoConcList(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        /// <summary>
        /// Metodo para obtener 1 Registro desde la Base de Datos de la Tabla dbax_info_conc
        /// </summary>
        ...
        {
            return _goDbaxInfoConcDAC.readDbaxInfoConc(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }
        ...
        { return _goDbaxInfoConcDAC.readDbaxInfoConcDt(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex); }

        /// <summary>
        /// Metodo para Actualizar los Datos de la Tabla dbax_info_conc, todos los parametros se asignan a traves de las BE
        /// </summary>
        /// <param name="toDbaxInfoConcBE"></param>
        public void updateDbaxInfoConc(DbaxInfoConcBE toDbaxInfoConcBE)
        {
            _goDbaxInfoConcDAC.updateDbaxInfoConc(toDbaxInfoConcBE);
        }

        /// <summary>
        /// Método para Eliminar 1 Registro de la tabla dbax_info_conc
        /// <param name="tnCodiEmpr"></param>
        /// <param name="tsCodiEmex"></param>
        /// <param name="tsCodiInfo"></param>
        /// <param name="tsPrefConc"></param>
        /// <param name="tsCodiConc"></param>
        /// <param name="tnOrdeConc"></param>
        /// </summary>
        ...
        {
            _goDbaxInfoConcDAC.deleteDbaxInfoConc(tnCodiEmpr, tsCodiEmex, tsCodiInfo, tsPrefConc, tsCodiConc, tnOrdeConc);
        }
    }
}