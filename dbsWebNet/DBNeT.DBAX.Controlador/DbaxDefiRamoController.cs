...
{
    public class DbaxDefiRamoController
    {
        DbaxDefiRamoDAC _goDbaxDefiRamoDAC;
        public DbaxDefiRamoController()
        { _goDbaxDefiRamoDAC = new DbaxDefiRamoDAC(); }

        /// <summary>
        /// Metodo para Insertar Registros en el Procedimiento Almacenado S_I_dbax_defi_ramo
        /// </summary>
        /// <param name="toDbaxDefiRamoBE"></param>
        public void createDbaxDefiRamo(DbaxDefiRamoBE toDbaxDefiRamoBE)
        {
            _goDbaxDefiRamoDAC.createDbaxDefiRamo(toDbaxDefiRamoBE);
        }

        /// <summary>
        /// Método para Obtener Los registros de la tabla dbax_defi_ramo, si se va a realizar un select para Mantenedor
        /// </summary>
        ...
        {
            return _goDbaxDefiRamoDAC.readDbaxDefiRamoList(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        /// <summary>
        /// Metodo para obtener 1 Registro desde la Base de Datos de la Tabla dbax_defi_ramo
        /// </summary>
        ...
        {
            return _goDbaxDefiRamoDAC.readDbaxDefiRamo(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }
        ...
        {
            return _goDbaxDefiRamoDAC.readDbaxDefiRamoDt(tsTipo, tnPagina, tnRegPag, tsCondicion, tsPar1, tsPar2, tsPar3, tsPar4, tsPar5, ts_codi_usua, tn_codi_empr, ts_codi_emex);
        }

        /// <summary>
        /// Metodo para Actualizar los Datos de la Tabla dbax_defi_ramo, todos los parametros se asignan a traves de las BE
        /// </summary>
        /// <param name="toDbaxDefiRamoBE"></param>
        public void updateDbaxDefiRamo(DbaxDefiRamoBE toDbaxDefiRamoBE)
        {
            _goDbaxDefiRamoDAC.updateDbaxDefiRamo(toDbaxDefiRamoBE);
        }

        /// <summary>
        /// Método para Eliminar 1 Registro de la tabla dbax_defi_ramo
        /// <param name="tsCodiSegm"></param>
        /// <param name="tsCodiRamo"></param>
        /// </summary>
        public void deleteDbaxDefiRamo(string tsCodiSegm, string tsCodiRamo,string tsTipoRamo)
        {
            _goDbaxDefiRamoDAC.deleteDbaxDefiRamo(tsCodiSegm, tsCodiRamo, tsTipoRamo);
        }
    }
}