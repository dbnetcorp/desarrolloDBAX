<%@ Page Title="" Language="C#" MasterPageFile="~/dbnet.dbax/MasterPage.master" AutoEventWireup="true" CodeFile="Indicadores.aspx.cs" Inherits="DragAndDrop" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyCP" Runat="Server">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox  CssClass="dbnTextbox" ID="tb_FormDefi" runat="server" AutoPostBack="True" 
                    ontextchanged="tb_FormDefi_TextChanged" style="text-transform:uppercase"></asp:TextBox>
    ...
    <table style="width: 50%;" border="0">
        <tr>
            <td class="style1">
                <asp:Label ID="Label12" runat="server" CssClass="lblIzquierdo" style="visibility:hidden">Formato</asp:Label>
                </td>
            <td>
                <asp:DropDownList ID="ddl_VersTaxo" runat="server" CssClass="dbnListaValor" AutoPostBack="True"
                    OnSelectedIndexChanged="ddl_VersTaxo_SelectedIndexChanged" style="visibility:hidden">
                </asp:DropDownList>
            </td>
        </tr>
        <!--<tr>
