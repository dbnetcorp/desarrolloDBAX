<%@ Page Title="" Language="C#" MasterPageFile="~/dbnet.dbax/MasterPage.master"  AutoEventWireup="true" CodeFile="RepMultiPeriodo.aspx.cs" Inherits="Website_spedsheet" %>
...
<div class="pageFw5">
    <asp:Label ID="Label10" runat="server" Text="Label" CssClass="dbnTitulo">Consulta Comparativo Empresa-Períodos</asp:Label>
    <br /><br />
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <table class="Selectores">
                <tr>
                    <td>
                        <asp:Label ID="Label4" runat="server" Text="Periodo inicial" 
                            CssClass="lblIzquierdo"/>
                        &nbsp;</td>
                    <td>
                        <asp:DropDownList CssClass="dbnListaValor" ID="ddl_CorrInstIni" runat="server"
                            Width="80" AutoPostBack="true" 
                            onselectedindexchanged="ddl_CorrInstIni_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="Periodo final" 
                            CssClass="lblIzquierdo"/>
                        &nbsp;</td>
                    <td>
                        <asp:DropDownList CssClass="dbnListaValor" ID="ddl_CorrInstFin" runat="server"
                            Width="80px" AutoPostBack="true" 
                            onselectedindexchanged="ddl_CorrInstFin_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList CssClass="dbnListaValor" ID="ddl_TipoTaxonomia" runat="server" Width="353px"
                            AutoPostBack="true" onselectedindexchanged="ddl_TipoTaxonomia_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList CssClass="dbnListaValor" ID="ddl_Grupo" runat="server" AutoPostBack="true" 
                                onselectedindexchanged="ddl_Grupo_SelectedIndexChanged" Width="353px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList CssClass="dbnListaValor" ID="ddl_Segmento" runat="server" AutoPostBack="true" 
                            onselectedindexchanged="ddl_Segmento_SelectedIndexChanged" Width="353px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td style="width:150px">
                        <asp:Label ID="Label5" runat="server" Text="Filtro Empresa" 
                            CssClass="lblIzquierdo"/>
                    </td>
                    <td>
                        <asp:TextBox CssClass="dbnTextbox" ID="Filtro_Empresa" runat="server" AutoPostBack="True" ontextchanged="Filtro_Empresa_TextChanged" Width="348px"></asp:TextBox>
                ...
                <tr>
                    <td style="width:150px">
                        <asp:Label ID="Label6" runat="server" Text="Empresa" CssClass="lblIzquierdo"/>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList CssClass="dbnListaValor" ID="ddl_CodiInfo" runat="server" Width="353px"
                            AutoPostBack="True" onselectedindexchanged="ddl_CodiInfo_SelectedIndexChanged" >
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td colspan="2" style="vertical-align: top;">
                    ...
                    <asp:TextBox ID="ruta_html" runat="server" style="visibility: hidden; background-color:AliceBlue;">../librerias/sheets/Inicio.html</asp:TextBox>
                    <asp:TextBox ID="tb_html" runat="server" style="visibility: hidden; background-color:Aqua;">0</asp:TextBox>
                    <br/>
                </td>
            </tr>
        </table>
