/****** Objeto:  StoredProcedure [dbo].[prc_dbn_defi_mone_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:03 ******/
DROP PROCEDURE [dbo].[prc_dbn_defi_mone_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getMaxOrdeConc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:58 ******/
DROP PROCEDURE [dbo].[SP_AX_getMaxOrdeConc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_DelTempIndi]    Fecha de la secuencia de comandos: 10/04/2013 16:26:45 ******/
DROP PROCEDURE [dbo].[SP_AX_DelTempIndi]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_defi_mone_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:25:03 ******/
DROP PROCEDURE [dbo].[prc_dbn_defi_mone_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_defi_mone_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:04 ******/
DROP PROCEDURE [dbo].[prc_dbn_defi_mone_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetValoInst]    Fecha de la secuencia de comandos: 10/04/2013 16:27:04 ******/
DROP PROCEDURE [dbo].[SP_AX_GetValoInst]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insCntxInst]    Fecha de la secuencia de comandos: 10/04/2013 16:27:07 ******/
DROP PROCEDURE [dbo].[SP_AX_insCntxInst]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_InstEmpreArchXbrl]    Fecha de la secuencia de comandos: 10/04/2013 16:27:15 ******/
DROP PROCEDURE [dbo].[SP_AX_InstEmpreArchXbrl]
GO
/****** Objeto:  UserDefinedFunction [dbo].[dbax_bi_getConcepto]    Fecha de la secuencia de comandos: 10/04/2013 16:27:22 ******/
DROP FUNCTION [dbo].[dbax_bi_getConcepto]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_defi_mone_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:04 ******/
DROP PROCEDURE [dbo].[prc_dbn_defi_mone_update]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_UpdaCntxInst]    Fecha de la secuencia de comandos: 10/04/2013 16:27:17 ******/
DROP PROCEDURE [dbo].[SP_AX_UpdaCntxInst]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_InsDetaIndi]    Fecha de la secuencia de comandos: 10/04/2013 16:27:08 ******/
DROP PROCEDURE [dbo].[SP_AX_InsDetaIndi]
GO
/****** Objeto:  UserDefinedFunction [dbo].[dbax_bi_getContexto]    Fecha de la secuencia de comandos: 10/04/2013 16:27:22 ******/
DROP FUNCTION [dbo].[dbax_bi_getContexto]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_camb_mone_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:02 ******/
DROP PROCEDURE [dbo].[prc_dbn_camb_mone_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insHtmlDife]    Fecha de la secuencia de comandos: 10/04/2013 16:27:10 ******/
DROP PROCEDURE [dbo].[SP_AX_insHtmlDife]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_prueba]    Fecha de la secuencia de comandos: 10/04/2013 16:27:16 ******/
DROP PROCEDURE [dbo].[SP_AX_prueba]
GO
/****** Objeto:  UserDefinedFunction [dbo].[dbax_bi_getPeriodo]    Fecha de la secuencia de comandos: 10/04/2013 16:27:23 ******/
DROP FUNCTION [dbo].[dbax_bi_getPeriodo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_camb_mone_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:25:02 ******/
DROP PROCEDURE [dbo].[prc_dbn_camb_mone_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insInstDicx]    Fecha de la secuencia de comandos: 10/04/2013 16:27:12 ******/
DROP PROCEDURE [dbo].[SP_AX_insInstDicx]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getIndicadores]    Fecha de la secuencia de comandos: 10/04/2013 16:26:54 ******/
DROP PROCEDURE [dbo].[SP_AX_getIndicadores]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInforme]    Fecha de la secuencia de comandos: 10/04/2013 16:26:55 ******/
DROP PROCEDURE [dbo].[SP_AX_getInforme]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_code_categoria]    Fecha de la secuencia de comandos: 10/04/2013 16:26:06 ******/
DROP PROCEDURE [dbo].[prc_sys_code_categoria]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insInstUnit]    Fecha de la secuencia de comandos: 10/04/2013 16:27:14 ******/
DROP PROCEDURE [dbo].[SP_AX_insInstUnit]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_UpdaInstUnit]    Fecha de la secuencia de comandos: 10/04/2013 16:27:18 ******/
DROP PROCEDURE [dbo].[SP_AX_UpdaInstUnit]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetContextosIndicadorEmpresa]    Fecha de la secuencia de comandos: 10/04/2013 16:26:50 ******/
DROP PROCEDURE [dbo].[SP_AX_GetContextosIndicadorEmpresa]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getPrefConcPorCodiConc]    Fecha de la secuencia de comandos: 10/04/2013 16:27:02 ******/
DROP PROCEDURE [dbo].[SP_AX_getPrefConcPorCodiConc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insInstConc]    Fecha de la secuencia de comandos: 10/04/2013 16:27:12 ******/
DROP PROCEDURE [dbo].[SP_AX_insInstConc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_delCntx]    Fecha de la secuencia de comandos: 10/04/2013 16:26:43 ******/
DROP PROCEDURE [dbo].[SP_AX_delCntx]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetInstHTML]    Fecha de la secuencia de comandos: 10/04/2013 16:26:57 ******/
DROP PROCEDURE [dbo].[SP_AX_GetInstHTML]
GO
/****** Objeto:  UserDefinedFunction [dbo].[separaMilesMone]    Fecha de la secuencia de comandos: 10/04/2013 16:27:28 ******/
DROP FUNCTION [dbo].[separaMilesMone]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_erro_logi_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:31 ******/
DROP PROCEDURE [dbo].[prc_erro_logi_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_InseUsuaSys]    Fecha de la secuencia de comandos: 10/04/2013 16:27:10 ******/
DROP PROCEDURE [dbo].[SP_AX_InseUsuaSys]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_erro_logi_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:31 ******/
DROP PROCEDURE [dbo].[prc_erro_logi_update]
GO
/****** Objeto:  UserDefinedFunction [dbo].[FU_AX_getValidaUsua]    Fecha de la secuencia de comandos: 10/04/2013 16:27:25 ******/
DROP FUNCTION [dbo].[FU_AX_getValidaUsua]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_cambiaPassDemo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:42 ******/
DROP PROCEDURE [dbo].[SP_AX_cambiaPassDemo]
GO
/****** Objeto:  UserDefinedFunction [dbo].[AXgetValor]    Fecha de la secuencia de comandos: 10/04/2013 16:27:22 ******/
DROP FUNCTION [dbo].[AXgetValor]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_erro_logi2_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:32 ******/
DROP PROCEDURE [dbo].[prc_erro_logi2_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_fech_vige_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:32 ******/
DROP PROCEDURE [dbo].[prc_fech_vige_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_fech_vige_usua_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:32 ******/
DROP PROCEDURE [dbo].[prc_fech_vige_usua_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetValoPara]    Fecha de la secuencia de comandos: 10/04/2013 16:27:05 ******/
DROP PROCEDURE [dbo].[SP_AX_GetValoPara]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_get_modulo_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:32 ******/
DROP PROCEDURE [dbo].[prc_get_modulo_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_pass_repe_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:42 ******/
DROP PROCEDURE [dbo].[prc_pass_repe_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetFechaCntx]    Fecha de la secuencia de comandos: 10/04/2013 16:26:54 ******/
DROP PROCEDURE [dbo].[SP_AX_GetFechaCntx]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_tipo_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:32 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_tipo_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_repo_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:12 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_repo_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getFechaContexto]    Fecha de la secuencia de comandos: 10/04/2013 16:26:54 ******/
DROP PROCEDURE [dbo].[SP_AX_getFechaContexto]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetRutaXBRL]    Fecha de la secuencia de comandos: 10/04/2013 16:27:02 ******/
DROP PROCEDURE [dbo].[SP_AX_GetRutaXBRL]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getGrupos]    Fecha de la secuencia de comandos: 10/04/2013 16:26:54 ******/
DROP PROCEDURE [dbo].[SP_AX_getGrupos]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_repo_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:13 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_repo_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_defi_grup]    Fecha de la secuencia de comandos: 10/04/2013 16:26:27 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_defi_grup]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_updInfoDefi]    Fecha de la secuencia de comandos: 10/04/2013 16:27:20 ******/
DROP PROCEDURE [dbo].[SP_AX_updInfoDefi]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_repo_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:14 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_repo_update]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInformesUsables]    Fecha de la secuencia de comandos: 10/04/2013 16:26:56 ******/
DROP PROCEDURE [dbo].[SP_AX_getInformesUsables]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_ejes]    Fecha de la secuencia de comandos: 10/04/2013 16:25:56 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_ejes]
GO
/****** Objeto:  UserDefinedFunction [dbo].[FU_AX_getMoneda]    Fecha de la secuencia de comandos: 10/04/2013 16:27:25 ******/
DROP FUNCTION [dbo].[FU_AX_getMoneda]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_boto_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:05 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_boto_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInfoValoColu]    Fecha de la secuencia de comandos: 10/04/2013 16:26:56 ******/
DROP PROCEDURE [dbo].[SP_AX_getInfoValoColu]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getPrefConc ]    Fecha de la secuencia de comandos: 10/04/2013 16:27:02 ******/
DROP PROCEDURE [dbo].[SP_AX_getPrefConc ]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInfoValoColuDimension]    Fecha de la secuencia de comandos: 10/04/2013 16:26:56 ******/
DROP PROCEDURE [dbo].[SP_AX_getInfoValoColuDimension]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getContextosInforme]    Fecha de la secuencia de comandos: 10/04/2013 16:26:50 ******/
DROP PROCEDURE [dbo].[SP_AX_getContextosInforme]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getCounDimeEjes]    Fecha de la secuencia de comandos: 10/04/2013 16:26:51 ******/
DROP PROCEDURE [dbo].[SP_AX_getCounDimeEjes]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_boto_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:06 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_boto_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetListaIndicadoresEmpresa]    Fecha de la secuencia de comandos: 10/04/2013 16:26:58 ******/
DROP PROCEDURE [dbo].[SP_AX_GetListaIndicadoresEmpresa]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetScheInfo]    Fecha de la secuencia de comandos: 10/04/2013 16:27:02 ******/
DROP PROCEDURE [dbo].[SP_AX_GetScheInfo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_boto_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:07 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_boto_update]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getProcesosPendientes]    Fecha de la secuencia de comandos: 10/04/2013 16:27:02 ******/
DROP PROCEDURE [dbo].[SP_AX_getProcesosPendientes]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insInstInfo]    Fecha de la secuencia de comandos: 10/04/2013 16:27:14 ******/
DROP PROCEDURE [dbo].[SP_AX_insInstInfo]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getConcepInfo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:49 ******/
DROP PROCEDURE [dbo].[SP_AX_getConcepInfo]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetConcPorPrefConc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:50 ******/
DROP PROCEDURE [dbo].[SP_AX_GetConcPorPrefConc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getSegmentos]    Fecha de la secuencia de comandos: 10/04/2013 16:27:02 ******/
DROP PROCEDURE [dbo].[SP_AX_getSegmentos]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetConcPorTaxonomia]    Fecha de la secuencia de comandos: 10/04/2013 16:26:50 ******/
DROP PROCEDURE [dbo].[SP_AX_GetConcPorTaxonomia]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetValoCntx]    Fecha de la secuencia de comandos: 10/04/2013 16:27:03 ******/
DROP PROCEDURE [dbo].[SP_AX_GetValoCntx]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_desc_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:25:56 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_desc_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_delIndi]    Fecha de la secuencia de comandos: 10/04/2013 16:26:43 ******/
DROP PROCEDURE [dbo].[SP_AX_delIndi]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetVersInst]    Fecha de la secuencia de comandos: 10/04/2013 16:27:05 ******/
DROP PROCEDURE [dbo].[SP_AX_GetVersInst]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_desc_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:25:18 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_desc_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_delInfoCntx]    Fecha de la secuencia de comandos: 10/04/2013 16:26:44 ******/
DROP PROCEDURE [dbo].[SP_AX_delInfoCntx]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insCntx]    Fecha de la secuencia de comandos: 10/04/2013 16:27:06 ******/
DROP PROCEDURE [dbo].[SP_AX_insCntx]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_desc_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:24:56 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_desc_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_InsDatosCalIndicadores]    Fecha de la secuencia de comandos: 10/04/2013 16:27:08 ******/
DROP PROCEDURE [dbo].[SP_AX_InsDatosCalIndicadores]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_desc_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:30 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_desc_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insEmpresaParaInforme]    Fecha de la secuencia de comandos: 10/04/2013 16:27:09 ******/
DROP PROCEDURE [dbo].[SP_AX_insEmpresaParaInforme]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insInfoConc]    Fecha de la secuencia de comandos: 10/04/2013 16:27:11 ******/
DROP PROCEDURE [dbo].[SP_AX_insInfoConc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_InsValoresIndicadores]    Fecha de la secuencia de comandos: 10/04/2013 16:27:15 ******/
DROP PROCEDURE [dbo].[SP_AX_InsValoresIndicadores]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbne_defi_lang]    Fecha de la secuencia de comandos: 10/04/2013 16:26:02 ******/
DROP PROCEDURE [dbo].[prc_read_dbne_defi_lang]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInformes]    Fecha de la secuencia de comandos: 10/04/2013 16:26:55 ******/
DROP PROCEDURE [dbo].[SP_AX_getInformes]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_pref_taxo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:05 ******/
DROP PROCEDURE [dbo].[prc_read_pref_taxo]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_UpdContexto]    Fecha de la secuencia de comandos: 10/04/2013 16:27:18 ******/
DROP PROCEDURE [dbo].[SP_AX_UpdContexto]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_pref_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:04 ******/
DROP PROCEDURE [dbo].[prc_read_pref_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_UpdDescEmpresa]    Fecha de la secuencia de comandos: 10/04/2013 16:27:19 ******/
DROP PROCEDURE [dbo].[SP_AX_UpdDescEmpresa]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbne_defi_lang]    Fecha de la secuencia de comandos: 10/04/2013 16:25:20 ******/
DROP PROCEDURE [dbo].[prc_delete_dbne_defi_lang]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_mant_list_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:35 ******/
DROP PROCEDURE [dbo].[prc_mant_list_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbne_defi_lang]    Fecha de la secuencia de comandos: 10/04/2013 16:24:59 ******/
DROP PROCEDURE [dbo].[prc_create_dbne_defi_lang]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insVersInst]    Fecha de la secuencia de comandos: 10/04/2013 16:27:16 ******/
DROP PROCEDURE [dbo].[SP_AX_insVersInst]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_repo_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:25:13 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_repo_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbne_defi_lang]    Fecha de la secuencia de comandos: 10/04/2013 16:26:32 ******/
DROP PROCEDURE [dbo].[prc_update_dbne_defi_lang]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insInfoCntx]    Fecha de la secuencia de comandos: 10/04/2013 16:27:10 ******/
DROP PROCEDURE [dbo].[SP_AX_insInfoCntx]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_ejem]    Fecha de la secuencia de comandos: 10/04/2013 16:26:46 ******/
DROP PROCEDURE [dbo].[SP_AX_ejem]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetPeriRang]    Fecha de la secuencia de comandos: 10/04/2013 16:27:01 ******/
DROP PROCEDURE [dbo].[SP_AX_GetPeriRang]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_boto_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:25:05 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_boto_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_RescAgru]    Fecha de la secuencia de comandos: 10/04/2013 16:27:16 ******/
DROP PROCEDURE [dbo].[SP_AX_RescAgru]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getPersCorrInst]    Fecha de la secuencia de comandos: 10/04/2013 16:27:01 ******/
DROP PROCEDURE [dbo].[SP_AX_getPersCorrInst]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_colu_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:09 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_colu_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_colu_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:25:09 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_colu_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_defi_peho]    Fecha de la secuencia de comandos: 10/04/2013 16:25:52 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_defi_peho]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_UpdEstadoservicio]    Fecha de la secuencia de comandos: 10/04/2013 16:27:19 ******/
DROP PROCEDURE [dbo].[SP_AX_UpdEstadoservicio]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetConcPorNombreTipo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:49 ******/
DROP PROCEDURE [dbo].[SP_AX_GetConcPorNombreTipo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_colu_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:10 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_colu_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_defi_pers]    Fecha de la secuencia de comandos: 10/04/2013 16:25:53 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_defi_pers]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_grupos_ax]    Fecha de la secuencia de comandos: 10/04/2013 16:26:02 ******/
DROP PROCEDURE [dbo].[prc_read_grupos_ax]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_list_repo]    Fecha de la secuencia de comandos: 10/04/2013 16:25:34 ******/
DROP PROCEDURE [dbo].[prc_list_repo]
GO
/****** Objeto:  UserDefinedFunction [dbo].[lpad]    Fecha de la secuencia de comandos: 10/04/2013 16:27:27 ******/
DROP FUNCTION [dbo].[lpad]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_UpdOrdenInforme]    Fecha de la secuencia de comandos: 10/04/2013 16:27:20 ******/
DROP PROCEDURE [dbo].[SP_AX_UpdOrdenInforme]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_colu_create_auto]    Fecha de la secuencia de comandos: 10/04/2013 16:25:09 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_colu_create_auto]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_homo_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:25:58 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_homo_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_repo_rous_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:15 ******/
DROP PROCEDURE [dbo].[prc_dbn_repo_rous_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_info_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:25:59 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_info_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getContextos]    Fecha de la secuencia de comandos: 10/04/2013 16:26:50 ******/
DROP PROCEDURE [dbo].[SP_AX_getContextos]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_repo_rous_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:25:15 ******/
DROP PROCEDURE [dbo].[prc_dbn_repo_rous_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_COMPANIA]    Fecha de la secuencia de comandos: 10/04/2013 16:26:43 ******/
DROP PROCEDURE [dbo].[SP_AX_COMPANIA]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbax_calc_actu]    Fecha de la secuencia de comandos: 10/04/2013 16:25:00 ******/
DROP PROCEDURE [dbo].[prc_dbax_calc_actu]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_tipo_taxo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:01 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_tipo_taxo]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInformesContextos ]    Fecha de la secuencia de comandos: 10/04/2013 16:26:55 ******/
DROP PROCEDURE [dbo].[SP_AX_getInformesContextos ]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_repo_rous_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:16 ******/
DROP PROCEDURE [dbo].[prc_dbn_repo_rous_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_taxo_vers]    Fecha de la secuencia de comandos: 10/04/2013 16:26:00 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_taxo_vers]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_calc_mone_all]    Fecha de la secuencia de comandos: 10/04/2013 16:24:47 ******/
DROP PROCEDURE [dbo].[prc_calc_mone_all]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_repo_rous_read_busq]    Fecha de la secuencia de comandos: 10/04/2013 16:25:16 ******/
DROP PROCEDURE [dbo].[prc_dbn_repo_rous_read_busq]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_homo_deta]    Fecha de la secuencia de comandos: 10/04/2013 16:25:59 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_homo_deta]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_object_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:16 ******/
DROP PROCEDURE [dbo].[prc_sys_object_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_Valida_orde_info_cntx]    Fecha de la secuencia de comandos: 10/04/2013 16:27:21 ******/
DROP PROCEDURE [dbo].[SP_AX_Valida_orde_info_cntx]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_defi_segm]    Fecha de la secuencia de comandos: 10/04/2013 16:25:55 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_defi_segm]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getArchivosXbrl]    Fecha de la secuencia de comandos: 10/04/2013 16:26:47 ******/
DROP PROCEDURE [dbo].[SP_AX_getArchivosXbrl]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_object_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:16 ******/
DROP PROCEDURE [dbo].[prc_sys_object_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_defi_ramo]    Fecha de la secuencia de comandos: 10/04/2013 16:25:54 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_defi_ramo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_object_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:17 ******/
DROP PROCEDURE [dbo].[prc_sys_object_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_defi_grup]    Fecha de la secuencia de comandos: 10/04/2013 16:25:52 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_defi_grup]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_object_update]    Fecha de la secuencia de comandos: 10/04/2013 16:26:20 ******/
DROP PROCEDURE [dbo].[prc_sys_object_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_relation_create_menu]    Fecha de la secuencia de comandos: 10/04/2013 16:26:22 ******/
DROP PROCEDURE [dbo].[prc_sys_relation_create_menu]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_InsertaGrupo]    Fecha de la secuencia de comandos: 10/04/2013 16:27:09 ******/
DROP PROCEDURE [dbo].[SP_AX_InsertaGrupo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_codi_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:25:50 ******/
DROP PROCEDURE [dbo].[prc_read_codi_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getArchivosPorGrupoSegmento]    Fecha de la secuencia de comandos: 10/04/2013 16:26:47 ******/
DROP PROCEDURE [dbo].[SP_AX_getArchivosPorGrupoSegmento]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_relation_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:23 ******/
DROP PROCEDURE [dbo].[prc_sys_relation_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_ciudad]    Fecha de la secuencia de comandos: 10/04/2013 16:25:49 ******/
DROP PROCEDURE [dbo].[prc_read_ciudad]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_pass_usua_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:42 ******/
DROP PROCEDURE [dbo].[prc_pass_usua_update]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_InsertarNuevoInforme]    Fecha de la secuencia de comandos: 10/04/2013 16:27:09 ******/
DROP PROCEDURE [dbo].[SP_AX_InsertarNuevoInforme]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_defi_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:25:51 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_defi_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getValoresPorInfoDimeCntx]    Fecha de la secuencia de comandos: 10/04/2013 16:27:05 ******/
DROP PROCEDURE [dbo].[SP_AX_getValoresPorInfoDimeCntx]
GO
/****** Objeto:  UserDefinedFunction [dbo].[AXgetCntx]    Fecha de la secuencia de comandos: 10/04/2013 16:27:21 ******/
DROP FUNCTION [dbo].[AXgetCntx]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_priv_logi_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:48 ******/
DROP PROCEDURE [dbo].[prc_priv_logi_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getCodiFech]    Fecha de la secuencia de comandos: 10/04/2013 16:26:48 ******/
DROP PROCEDURE [dbo].[SP_AX_getCodiFech]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_defi_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:25:17 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_defi_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_esta_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:35 ******/
DROP PROCEDURE [dbo].[prc_usua_esta_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_defi_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:24:53 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_defi_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_esta_update]    Fecha de la secuencia de comandos: 10/04/2013 16:26:35 ******/
DROP PROCEDURE [dbo].[prc_usua_esta_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_defi_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:27 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_defi_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_proc_even]    Fecha de la secuencia de comandos: 10/04/2013 16:24:58 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_proc_even]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_sist_event_cor_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:37 ******/
DROP PROCEDURE [dbo].[prc_usua_sist_event_cor_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetDetaIndicadores]    Fecha de la secuencia de comandos: 10/04/2013 16:26:51 ******/
DROP PROCEDURE [dbo].[SP_AX_GetDetaIndicadores]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_tipo_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:01 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_tipo_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_proc_even]    Fecha de la secuencia de comandos: 10/04/2013 16:26:00 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_proc_even]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_sist_event_inf_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:39 ******/
DROP PROCEDURE [dbo].[prc_usua_sist_event_inf_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getEmpresaConFiltro]    Fecha de la secuencia de comandos: 10/04/2013 16:26:52 ******/
DROP PROCEDURE [dbo].[SP_AX_getEmpresaConFiltro]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_tipo_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:25:20 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_tipo_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getMiembrosDimensionEmpresaPeriodoVersion]    Fecha de la secuencia de comandos: 10/04/2013 16:27:00 ******/
DROP PROCEDURE [dbo].[SP_AX_getMiembrosDimensionEmpresaPeriodoVersion]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbax_inst_conc_conv_mone]    Fecha de la secuencia de comandos: 10/04/2013 16:25:01 ******/
DROP PROCEDURE [dbo].[prc_dbax_inst_conc_conv_mone]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_cate_repo_read]    Fecha de la secuencia de comandos: 10/04/2013 16:24:47 ******/
DROP PROCEDURE [dbo].[prc_cate_repo_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getEmpresaPorGrupoSegmento]    Fecha de la secuencia de comandos: 10/04/2013 16:26:53 ******/
DROP PROCEDURE [dbo].[SP_AX_getEmpresaPorGrupoSegmento]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_tipo_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:24:58 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_tipo_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_sesion_update_fete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:25 ******/
DROP PROCEDURE [dbo].[prc_sys_sesion_update_fete]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getCodigosEmpresa]    Fecha de la secuencia de comandos: 10/04/2013 16:26:48 ******/
DROP PROCEDURE [dbo].[SP_AX_getCodigosEmpresa]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getValoConc]    Fecha de la secuencia de comandos: 10/04/2013 16:27:04 ******/
DROP PROCEDURE [dbo].[SP_AX_getValoConc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_rous_menu_furo]    Fecha de la secuencia de comandos: 10/04/2013 16:25:00 ******/
DROP PROCEDURE [dbo].[prc_create_rous_menu_furo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_list_valo]    Fecha de la secuencia de comandos: 10/04/2013 16:25:34 ******/
DROP PROCEDURE [dbo].[prc_list_valo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_exec_bin]    Fecha de la secuencia de comandos: 10/04/2013 16:24:59 ******/
DROP PROCEDURE [dbo].[prc_create_exec_bin]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_furo_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:11 ******/
DROP PROCEDURE [dbo].[prc_sys_furo_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_sys_object]    Fecha de la secuencia de comandos: 10/04/2013 16:25:20 ******/
DROP PROCEDURE [dbo].[prc_delete_sys_object]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_furo_menu_rol]    Fecha de la secuencia de comandos: 10/04/2013 16:26:12 ******/
DROP PROCEDURE [dbo].[prc_sys_furo_menu_rol]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_Elimina_grilla_grupo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:46 ******/
DROP PROCEDURE [dbo].[SP_AX_Elimina_grilla_grupo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_tipo_taxo]    Fecha de la secuencia de comandos: 10/04/2013 16:25:20 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_tipo_taxo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_domain_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:09 ******/
DROP PROCEDURE [dbo].[prc_sys_domain_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_defi_segm]    Fecha de la secuencia de comandos: 10/04/2013 16:25:18 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_defi_segm]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_domain_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:09 ******/
DROP PROCEDURE [dbo].[prc_sys_domain_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbax_proc_homo]    Fecha de la secuencia de comandos: 10/04/2013 16:25:01 ******/
DROP PROCEDURE [dbo].[prc_dbax_proc_homo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_domain_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:10 ******/
DROP PROCEDURE [dbo].[prc_sys_domain_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_domain_update]    Fecha de la secuencia de comandos: 10/04/2013 16:26:11 ******/
DROP PROCEDURE [dbo].[prc_sys_domain_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_tipo_taxo]    Fecha de la secuencia de comandos: 10/04/2013 16:24:59 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_tipo_taxo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_code_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:07 ******/
DROP PROCEDURE [dbo].[prc_sys_code_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_defi_segm]    Fecha de la secuencia de comandos: 10/04/2013 16:24:55 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_defi_segm]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_code_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:07 ******/
DROP PROCEDURE [dbo].[prc_sys_code_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_defi_grup]    Fecha de la secuencia de comandos: 10/04/2013 16:24:54 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_defi_grup]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_code_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:08 ******/
DROP PROCEDURE [dbo].[prc_sys_code_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_defi_segm]    Fecha de la secuencia de comandos: 10/04/2013 16:26:29 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_defi_segm]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insInstMemb]    Fecha de la secuencia de comandos: 10/04/2013 16:27:14 ******/
DROP PROCEDURE [dbo].[SP_AX_insInstMemb]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_code_update]    Fecha de la secuencia de comandos: 10/04/2013 16:26:08 ******/
DROP PROCEDURE [dbo].[prc_sys_code_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_area_geog_read_comunas]    Fecha de la secuencia de comandos: 10/04/2013 16:24:46 ******/
DROP PROCEDURE [dbo].[prc_area_geog_read_comunas]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insConcDife]    Fecha de la secuencia de comandos: 10/04/2013 16:27:07 ******/
DROP PROCEDURE [dbo].[SP_AX_insConcDife]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_inssSerivicio]    Fecha de la secuencia de comandos: 10/04/2013 16:27:15 ******/
DROP PROCEDURE [dbo].[SP_AX_inssSerivicio]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_area_geog_read_pais]    Fecha de la secuencia de comandos: 10/04/2013 16:24:47 ******/
DROP PROCEDURE [dbo].[prc_area_geog_read_pais]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbn_list_colu_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:11 ******/
DROP PROCEDURE [dbo].[prc_dbn_list_colu_update]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insInstDime]    Fecha de la secuencia de comandos: 10/04/2013 16:27:13 ******/
DROP PROCEDURE [dbo].[SP_AX_insInstDime]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getDimensionesUsables]    Fecha de la secuencia de comandos: 10/04/2013 16:26:52 ******/
DROP PROCEDURE [dbo].[SP_AX_getDimensionesUsables]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getMiembroInstMemb ]    Fecha de la secuencia de comandos: 10/04/2013 16:26:59 ******/
DROP PROCEDURE [dbo].[SP_AX_getMiembroInstMemb ]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getMiembrosDimension ]    Fecha de la secuencia de comandos: 10/04/2013 16:26:59 ******/
DROP PROCEDURE [dbo].[SP_AX_getMiembrosDimension ]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_rous_menu_categoria_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:05 ******/
DROP PROCEDURE [dbo].[prc_rous_menu_categoria_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_rous_menu_furo_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:06 ******/
DROP PROCEDURE [dbo].[prc_rous_menu_furo_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInfoDimensionDescConc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:55 ******/
DROP PROCEDURE [dbo].[SP_AX_getInfoDimensionDescConc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_rous_menu_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:06 ******/
DROP PROCEDURE [dbo].[prc_rous_menu_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getDimeDefi]    Fecha de la secuencia de comandos: 10/04/2013 16:26:52 ******/
DROP PROCEDURE [dbo].[SP_AX_getDimeDefi]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_rous_menu_relation_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:06 ******/
DROP PROCEDURE [dbo].[prc_rous_menu_relation_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetOrdenMembVari]    Fecha de la secuencia de comandos: 10/04/2013 16:27:00 ******/
DROP PROCEDURE [dbo].[SP_AX_GetOrdenMembVari]
GO
/****** Objeto:  UserDefinedFunction [dbo].[FU_AX_getValormiembroDimension]    Fecha de la secuencia de comandos: 10/04/2013 16:27:26 ******/
DROP FUNCTION [dbo].[FU_AX_getValormiembroDimension]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_cadu_update]    Fecha de la secuencia de comandos: 10/04/2013 16:26:33 ******/
DROP PROCEDURE [dbo].[prc_usua_cadu_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_info_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:31 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_info_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_sist_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:37 ******/
DROP PROCEDURE [dbo].[prc_usua_sist_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_taxo_vers]    Fecha de la secuencia de comandos: 10/04/2013 16:26:31 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_taxo_vers]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_sist_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:37 ******/
DROP PROCEDURE [dbo].[prc_usua_sist_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_sist_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:40 ******/
DROP PROCEDURE [dbo].[prc_usua_sist_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_homo_deta]    Fecha de la secuencia de comandos: 10/04/2013 16:26:31 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_homo_deta]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_sist_update]    Fecha de la secuencia de comandos: 10/04/2013 16:26:42 ******/
DROP PROCEDURE [dbo].[prc_usua_sist_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_homo_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:30 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_homo_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_vali_usua_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:42 ******/
DROP PROCEDURE [dbo].[prc_vali_usua_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_usro_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:25 ******/
DROP PROCEDURE [dbo].[prc_sys_usro_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_defi_ramo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:29 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_defi_ramo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_usro_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:25 ******/
DROP PROCEDURE [dbo].[prc_sys_usro_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_defi_pers]    Fecha de la secuencia de comandos: 10/04/2013 16:26:28 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_defi_pers]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_usro_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:26 ******/
DROP PROCEDURE [dbo].[prc_sys_usro_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_defi_peho]    Fecha de la secuencia de comandos: 10/04/2013 16:26:28 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_defi_peho]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_usro_update]    Fecha de la secuencia de comandos: 10/04/2013 16:26:27 ******/
DROP PROCEDURE [dbo].[prc_sys_usro_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_get_rol_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:32 ******/
DROP PROCEDURE [dbo].[prc_get_rol_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_sist_event_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:38 ******/
DROP PROCEDURE [dbo].[prc_usua_sist_event_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_Get_Ingreso]    Fecha de la secuencia de comandos: 10/04/2013 16:26:46 ******/
DROP PROCEDURE [dbo].[SP_AX_Get_Ingreso]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_sist_event_create_cor]    Fecha de la secuencia de comandos: 10/04/2013 16:26:38 ******/
DROP PROCEDURE [dbo].[prc_usua_sist_event_create_cor]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_delInstDocu]    Fecha de la secuencia de comandos: 10/04/2013 16:26:45 ******/
DROP PROCEDURE [dbo].[SP_AX_delInstDocu]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_sist_event_create_inf]    Fecha de la secuencia de comandos: 10/04/2013 16:26:39 ******/
DROP PROCEDURE [dbo].[prc_usua_sist_event_create_inf]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetDatosGrupo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:51 ******/
DROP PROCEDURE [dbo].[SP_AX_GetDatosGrupo]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insInstDocu]    Fecha de la secuencia de comandos: 10/04/2013 16:27:13 ******/
DROP PROCEDURE [dbo].[SP_AX_insInstDocu]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_empr_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:22 ******/
DROP PROCEDURE [dbo].[prc_empr_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_empr_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:25:23 ******/
DROP PROCEDURE [dbo].[prc_empr_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getTiposTaxonomia]    Fecha de la secuencia de comandos: 10/04/2013 16:27:03 ******/
DROP PROCEDURE [dbo].[SP_AX_getTiposTaxonomia]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_empr_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:29 ******/
DROP PROCEDURE [dbo].[prc_empr_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInfoDescConc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:55 ******/
DROP PROCEDURE [dbo].[SP_AX_getInfoDescConc]
GO
/****** Objeto:  StoredProcedure [dbo].[dbnet_init_sess]    Fecha de la secuencia de comandos: 10/04/2013 16:24:44 ******/
DROP PROCEDURE [dbo].[dbnet_init_sess]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_empr_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:31 ******/
DROP PROCEDURE [dbo].[prc_empr_update]
GO
/****** Objeto:  UserDefinedFunction [dbo].[dbnet_get_usua]    Fecha de la secuencia de comandos: 10/04/2013 16:27:24 ******/
DROP FUNCTION [dbo].[dbnet_get_usua]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_cent_cost_create]    Fecha de la secuencia de comandos: 10/04/2013 16:24:49 ******/
DROP PROCEDURE [dbo].[prc_cent_cost_create]
GO
/****** Objeto:  UserDefinedFunction [dbo].[dbnet_get_rous]    Fecha de la secuencia de comandos: 10/04/2013 16:27:23 ******/
DROP FUNCTION [dbo].[dbnet_get_rous]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_cent_cost_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:24:49 ******/
DROP PROCEDURE [dbo].[prc_cent_cost_delete]
GO
/****** Objeto:  UserDefinedFunction [dbo].[dbnet_get_pers]    Fecha de la secuencia de comandos: 10/04/2013 16:27:23 ******/
DROP FUNCTION [dbo].[dbnet_get_pers]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetMaxColum]    Fecha de la secuencia de comandos: 10/04/2013 16:26:58 ******/
DROP PROCEDURE [dbo].[SP_AX_GetMaxColum]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_cent_cost_read]    Fecha de la secuencia de comandos: 10/04/2013 16:24:50 ******/
DROP PROCEDURE [dbo].[prc_cent_cost_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_Del_grupo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:43 ******/
DROP PROCEDURE [dbo].[SP_AX_Del_grupo]
GO
/****** Objeto:  UserDefinedFunction [dbo].[dbnet_get_modu]    Fecha de la secuencia de comandos: 10/04/2013 16:27:23 ******/
DROP FUNCTION [dbo].[dbnet_get_modu]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_cent_cost_update]    Fecha de la secuencia de comandos: 10/04/2013 16:24:51 ******/
DROP PROCEDURE [dbo].[prc_cent_cost_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_taxo_vers]    Fecha de la secuencia de comandos: 10/04/2013 16:25:19 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_taxo_vers]
GO
/****** Objeto:  UserDefinedFunction [dbo].[dbnet_get_empr]    Fecha de la secuencia de comandos: 10/04/2013 16:27:23 ******/
DROP FUNCTION [dbo].[dbnet_get_empr]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_personas_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:44 ******/
DROP PROCEDURE [dbo].[prc_personas_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_info_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:25:19 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_info_conc]
GO
/****** Objeto:  UserDefinedFunction [dbo].[dbnet_get_emex]    Fecha de la secuencia de comandos: 10/04/2013 16:27:23 ******/
DROP FUNCTION [dbo].[dbnet_get_emex]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_delInfoDefi]    Fecha de la secuencia de comandos: 10/04/2013 16:26:45 ******/
DROP PROCEDURE [dbo].[SP_AX_delInfoDefi]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_personas_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:45 ******/
DROP PROCEDURE [dbo].[prc_personas_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_homo_deta]    Fecha de la secuencia de comandos: 10/04/2013 16:25:19 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_homo_deta]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_insInfoDefi]    Fecha de la secuencia de comandos: 10/04/2013 16:27:11 ******/
DROP PROCEDURE [dbo].[SP_AX_insInfoDefi]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_personas_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:48 ******/
DROP PROCEDURE [dbo].[prc_personas_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_homo_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:25:18 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_homo_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[dbnet_context]    Fecha de la secuencia de comandos: 10/04/2013 16:24:44 ******/
DROP PROCEDURE [dbo].[dbnet_context]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_rous_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:23 ******/
DROP PROCEDURE [dbo].[prc_sys_rous_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_rous_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:23 ******/
DROP PROCEDURE [dbo].[prc_sys_rous_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_defi_ramo]    Fecha de la secuencia de comandos: 10/04/2013 16:25:18 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_defi_ramo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_rous_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:24 ******/
DROP PROCEDURE [dbo].[prc_sys_rous_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInfoDefi]    Fecha de la secuencia de comandos: 10/04/2013 16:26:54 ******/
DROP PROCEDURE [dbo].[SP_AX_getInfoDefi]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_defi_pers]    Fecha de la secuencia de comandos: 10/04/2013 16:25:17 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_defi_pers]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_cent_cost]    Fecha de la secuencia de comandos: 10/04/2013 16:25:16 ******/
DROP PROCEDURE [dbo].[prc_delete_cent_cost]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_rous_update]    Fecha de la secuencia de comandos: 10/04/2013 16:26:25 ******/
DROP PROCEDURE [dbo].[prc_sys_rous_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_delete_dbax_defi_peho]    Fecha de la secuencia de comandos: 10/04/2013 16:25:17 ******/
DROP PROCEDURE [dbo].[prc_delete_dbax_defi_peho]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_cent_cost]    Fecha de la secuencia de comandos: 10/04/2013 16:24:53 ******/
DROP PROCEDURE [dbo].[prc_create_cent_cost]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_empr_exte_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:25 ******/
DROP PROCEDURE [dbo].[prc_empr_exte_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_empr_exte_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:25:25 ******/
DROP PROCEDURE [dbo].[prc_empr_exte_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_taxo_vers]    Fecha de la secuencia de comandos: 10/04/2013 16:24:58 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_taxo_vers]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_empr_exte_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:26 ******/
DROP PROCEDURE [dbo].[prc_empr_exte_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_info_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:24:57 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_info_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_RescEmrInfor]    Fecha de la secuencia de comandos: 10/04/2013 16:27:16 ******/
DROP PROCEDURE [dbo].[SP_AX_RescEmrInfor]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_empr_exte_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:28 ******/
DROP PROCEDURE [dbo].[prc_empr_exte_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_homo_deta]    Fecha de la secuencia de comandos: 10/04/2013 16:24:57 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_homo_deta]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_param_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:21 ******/
DROP PROCEDURE [dbo].[prc_sys_param_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_homo_conc]    Fecha de la secuencia de comandos: 10/04/2013 16:24:56 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_homo_conc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_param_update]    Fecha de la secuencia de comandos: 10/04/2013 16:26:22 ******/
DROP PROCEDURE [dbo].[prc_sys_param_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_defi_pers]    Fecha de la secuencia de comandos: 10/04/2013 16:24:55 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_defi_pers]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_ramos]    Fecha de la secuencia de comandos: 10/04/2013 16:26:00 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_ramos]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_InsBase64XBRL]    Fecha de la secuencia de comandos: 10/04/2013 16:27:06 ******/
DROP PROCEDURE [dbo].[SP_AX_InsBase64XBRL]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_ofic_empr_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:37 ******/
DROP PROCEDURE [dbo].[prc_ofic_empr_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_defi_peho]    Fecha de la secuencia de comandos: 10/04/2013 16:24:54 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_defi_peho]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_cuadros]    Fecha de la secuencia de comandos: 10/04/2013 16:25:50 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_cuadros]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_ofic_empr_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:25:37 ******/
DROP PROCEDURE [dbo].[prc_ofic_empr_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_conceptos]    Fecha de la secuencia de comandos: 10/04/2013 16:25:50 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_conceptos]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetEncaIndi]    Fecha de la secuencia de comandos: 10/04/2013 16:26:53 ******/
DROP PROCEDURE [dbo].[SP_AX_GetEncaIndi]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_ofic_empr_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:38 ******/
DROP PROCEDURE [dbo].[prc_ofic_empr_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_update_dbax_tipo_taxo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:32 ******/
DROP PROCEDURE [dbo].[prc_update_dbax_tipo_taxo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_empresa]    Fecha de la secuencia de comandos: 10/04/2013 16:25:56 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_empresa]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetDetaIndi]    Fecha de la secuencia de comandos: 10/04/2013 16:26:51 ******/
DROP PROCEDURE [dbo].[SP_AX_GetDetaIndi]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_ofic_empr_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:39 ******/
DROP PROCEDURE [dbo].[prc_ofic_empr_update]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getPersCorrVersInst]    Fecha de la secuencia de comandos: 10/04/2013 16:27:01 ******/
DROP PROCEDURE [dbo].[SP_AX_getPersCorrVersInst]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_mens_erro]    Fecha de la secuencia de comandos: 10/04/2013 16:25:36 ******/
DROP PROCEDURE [dbo].[prc_mens_erro]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_InsEncaIndi]    Fecha de la secuencia de comandos: 10/04/2013 16:27:09 ******/
DROP PROCEDURE [dbo].[SP_AX_InsEncaIndi]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_para_empr_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:40 ******/
DROP PROCEDURE [dbo].[prc_para_empr_create]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getEmpresa]    Fecha de la secuencia de comandos: 10/04/2013 16:26:52 ******/
DROP PROCEDURE [dbo].[SP_AX_getEmpresa]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_para_empr_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:25:40 ******/
DROP PROCEDURE [dbo].[prc_para_empr_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_Upd_grupo_Empr]    Fecha de la secuencia de comandos: 10/04/2013 16:27:17 ******/
DROP PROCEDURE [dbo].[SP_AX_Upd_grupo_Empr]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_getValorColumnaRamo]    Fecha de la secuencia de comandos: 10/04/2013 16:25:57 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_getValorColumnaRamo]
GO
/****** Objeto:  StoredProcedure [dbo].[BORRAR_SP_AX_getConceptos]    Fecha de la secuencia de comandos: 10/04/2013 16:24:43 ******/
DROP PROCEDURE [dbo].[BORRAR_SP_AX_getConceptos]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_para_empr_read]    Fecha de la secuencia de comandos: 10/04/2013 16:25:41 ******/
DROP PROCEDURE [dbo].[prc_para_empr_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetConcDife]    Fecha de la secuencia de comandos: 10/04/2013 16:26:49 ******/
DROP PROCEDURE [dbo].[SP_AX_GetConcDife]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_para_empr_update]    Fecha de la secuencia de comandos: 10/04/2013 16:25:41 ******/
DROP PROCEDURE [dbo].[prc_para_empr_update]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_empr_create]    Fecha de la secuencia de comandos: 10/04/2013 16:26:33 ******/
DROP PROCEDURE [dbo].[prc_usua_empr_create]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_empr_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:33 ******/
DROP PROCEDURE [dbo].[prc_usua_empr_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_delInfoConc]    Fecha de la secuencia de comandos: 10/04/2013 16:26:44 ******/
DROP PROCEDURE [dbo].[SP_AX_delInfoConc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_empr_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:34 ******/
DROP PROCEDURE [dbo].[prc_usua_empr_read]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getTipoMone]    Fecha de la secuencia de comandos: 10/04/2013 16:27:03 ******/
DROP PROCEDURE [dbo].[SP_AX_getTipoMone]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_delInstDocuVers]    Fecha de la secuencia de comandos: 10/04/2013 16:26:45 ******/
DROP PROCEDURE [dbo].[SP_AX_delInstDocuVers]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_usua_empr_update]    Fecha de la secuencia de comandos: 10/04/2013 16:26:34 ******/
DROP PROCEDURE [dbo].[prc_usua_empr_update]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInstDimeVers]    Fecha de la secuencia de comandos: 10/04/2013 16:26:57 ******/
DROP PROCEDURE [dbo].[SP_AX_getInstDimeVers]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_module_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:12 ******/
DROP PROCEDURE [dbo].[prc_sys_module_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_lista_lndi_emp]    Fecha de la secuencia de comandos: 10/04/2013 16:26:03 ******/
DROP PROCEDURE [dbo].[prc_read_lista_lndi_emp]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_area_geog_read_ciudad]    Fecha de la secuencia de comandos: 10/04/2013 16:24:45 ******/
DROP PROCEDURE [dbo].[prc_area_geog_read_ciudad]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetEmpresasIndicadores]    Fecha de la secuencia de comandos: 10/04/2013 16:26:53 ******/
DROP PROCEDURE [dbo].[SP_AX_GetEmpresasIndicadores]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_updInfoConc]    Fecha de la secuencia de comandos: 10/04/2013 16:27:20 ******/
DROP PROCEDURE [dbo].[SP_AX_updInfoConc]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_param_delete]    Fecha de la secuencia de comandos: 10/04/2013 16:26:21 ******/
DROP PROCEDURE [dbo].[prc_sys_param_delete]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_GetBase64XBRL]    Fecha de la secuencia de comandos: 10/04/2013 16:26:48 ******/
DROP PROCEDURE [dbo].[SP_AX_GetBase64XBRL]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_sys_param_read]    Fecha de la secuencia de comandos: 10/04/2013 16:26:22 ******/
DROP PROCEDURE [dbo].[prc_sys_param_read]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_create_dbax_defi_ramo]    Fecha de la secuencia de comandos: 10/04/2013 16:24:55 ******/
DROP PROCEDURE [dbo].[prc_create_dbax_defi_ramo]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_read_dbax_dimensiones]    Fecha de la secuencia de comandos: 10/04/2013 16:25:56 ******/
DROP PROCEDURE [dbo].[prc_read_dbax_dimensiones]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_Ins_GrupoEmpr]    Fecha de la secuencia de comandos: 10/04/2013 16:27:05 ******/
DROP PROCEDURE [dbo].[SP_AX_Ins_GrupoEmpr]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getAxisMemb]    Fecha de la secuencia de comandos: 10/04/2013 16:26:48 ******/
DROP PROCEDURE [dbo].[SP_AX_getAxisMemb]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInformesDimension]    Fecha de la secuencia de comandos: 10/04/2013 16:26:55 ******/
DROP PROCEDURE [dbo].[SP_AX_getInformesDimension]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_list_dyn]    Fecha de la secuencia de comandos: 10/04/2013 16:25:33 ******/
DROP PROCEDURE [dbo].[prc_list_dyn]
GO
/****** Objeto:  UserDefinedFunction [dbo].[AX_getDescInfo]    Fecha de la secuencia de comandos: 10/04/2013 16:27:21 ******/
DROP FUNCTION [dbo].[AX_getDescInfo]
GO
/****** Objeto:  UserDefinedFunction [dbo].[separaMiles]    Fecha de la secuencia de comandos: 10/04/2013 16:27:28 ******/
DROP FUNCTION [dbo].[separaMiles]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_dbax_inse_data_hira]    Fecha de la secuencia de comandos: 10/04/2013 16:25:01 ******/
DROP PROCEDURE [dbo].[prc_dbax_inse_data_hira]
GO
/****** Objeto:  UserDefinedFunction [dbo].[FU_AX_getFechas]    Fecha de la secuencia de comandos: 10/04/2013 16:27:24 ******/
DROP FUNCTION [dbo].[FU_AX_getFechas]
GO
/****** Objeto:  UserDefinedFunction [dbo].[FU_AX_getDescFech]    Fecha de la secuencia de comandos: 10/04/2013 16:27:24 ******/
DROP FUNCTION [dbo].[FU_AX_getDescFech]
GO
/****** Objeto:  UserDefinedFunction [dbo].[addmonths]    Fecha de la secuencia de comandos: 10/04/2013 16:27:21 ******/
DROP FUNCTION [dbo].[addmonths]
GO
/****** Objeto:  UserDefinedFunction [dbo].[FU_AX_getUltimaVersion]    Fecha de la secuencia de comandos: 10/04/2013 16:27:25 ******/
DROP FUNCTION [dbo].[FU_AX_getUltimaVersion]
GO
/****** Objeto:  UserDefinedFunction [dbo].[FU_AX_getValorPorFecha]    Fecha de la secuencia de comandos: 10/04/2013 16:27:27 ******/
DROP FUNCTION [dbo].[FU_AX_getValorPorFecha]
GO
/****** Objeto:  StoredProcedure [dbo].[prc_mens_erro_create]    Fecha de la secuencia de comandos: 10/04/2013 16:25:36 ******/
DROP PROCEDURE [dbo].[prc_mens_erro_create]
GO
/****** Objeto:  UserDefinedFunction [dbo].[fnc_valida_privilegios]    Fecha de la secuencia de comandos: 10/04/2013 16:27:24 ******/
DROP FUNCTION [dbo].[fnc_valida_privilegios]
GO
/****** Objeto:  StoredProcedure [dbo].[dbnet_message]    Fecha de la secuencia de comandos: 10/04/2013 16:24:44 ******/
DROP PROCEDURE [dbo].[dbnet_message]
GO
/****** Objeto:  UserDefinedFunction [dbo].[lastday]    Fecha de la secuencia de comandos: 10/04/2013 16:27:27 ******/
DROP FUNCTION [dbo].[lastday]
GO
/****** Objeto:  UserDefinedFunction [dbo].[esNumero]    Fecha de la secuencia de comandos: 10/04/2013 16:27:24 ******/
DROP FUNCTION [dbo].[esNumero]
GO
/****** Objeto:  UserDefinedFunction [dbo].[rpad]    Fecha de la secuencia de comandos: 10/04/2013 16:27:27 ******/
DROP FUNCTION [dbo].[rpad]
GO
/****** Objeto:  UserDefinedFunction [dbo].[dbnet_get_cult]    Fecha de la secuencia de comandos: 10/04/2013 16:27:23 ******/
DROP FUNCTION [dbo].[dbnet_get_cult]
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_DelTempIndi]    Fecha de la secuencia de comandos: 10/04/2013 16:26:45 ******/
SET ANSI_NULLS ON
GO
...
GO
CREATE procedure [dbo].[SP_AX_DelTempIndi] as
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
CREATE function [dbo].[dbax_bi_getConcepto](@p_codi_info varchar(256), @p_codi_conc varchar(256)) returns varchar(256)
as
begin
...
SET QUOTED_IDENTIFIER ON
GO
CREATE function [dbo].[dbax_bi_getContexto](@p_fech_inic varchar(10), @p_fech_fina varchar(10)) returns varchar(256)
as
begin
...
SET QUOTED_IDENTIFIER ON
GO
CREATE function [dbo].[dbax_bi_getPeriodo](@p_fech_inic varchar(10), @p_fech_fina varchar(10)) returns varchar(256)
as
begin
  if (@p_fech_fina is null or @p_fech_fina = '')
  begin
...
SET QUOTED_IDENTIFIER ON
GO
CREATE function [dbo].[lastday](@pPeriodo varchar(6)) returns datetime
begin
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_list_dyn] (
	@tsSql varchar(8000), 
	@tnPagina as integer,	
	@tnRegPag as integer)
AS
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_relation_create_menu](
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_relation_delete](
	@P_CODI_MODU VARCHAR(30),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_rous_menu_relation_create](
	@P_NOMB_MENU VARCHAR(30),
	@P_CODI_MODU VARCHAR(30),
	@P_NOMB_ROUS VARCHAR(30)
	)
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_homo_conc]
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_homo_conc]
            @P_CODI_HOCO numeric(22, 0) 
 AS
 BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_create_dbax_homo_conc] 
            @P_TIPO_TAXO varchar(10), 
            @P_PREF_CONC varchar(50), 
            @P_VERS_TAXO varchar(256), 
            @P_VERS_TAXO_DEST varchar(256)
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_dbn_defi_mone_delete]
...
-- Description:	<Description,,>
-- =============================================
create  procedure [dbo].[prc_dbn_defi_mone_read] (
 @tsTipo as VARCHAR(4),
 @tnPagina as INTEGER,
 @tnRegPag as INTEGER,
...
-- Description:	<Description,,>
-- =============================================
create  procedure [dbo].[prc_dbn_defi_mone_create]
            @P_CODI_MONE VARCHAR(3), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_dbn_defi_mone_update]
            @P_CODI_MONE VARCHAR(3), 
            @P_NOMB_MONE VARCHAR(50), 
            @P_CODI_PAIS VARCHAR(2), 
            @P_ROUN_MONE numeric(2, 0) 
...
-- Description:	<Description,,>
-- =============================================
create  procedure [dbo].[prc_dbn_camb_mone_create]
            @P_CODI_MONE VARCHAR(3), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_dbn_camb_mone_delete]
            @P_CODI_MONE VARCHAR(3) 
 AS
 BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[prc_read_dbax_ejes] 
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[SP_AX_getCounDimeEjes]
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[SP_AX_getAxisMemb] 
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_dbax_conceptos]
(
	@p_codi_dein varchar(128),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_defi_grup]
...
-- Description:	
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_grupos_ax] 
(
	 @tsTipo as Varchar(2),
	 @tnPagina as integer,
	 @tnRegPag as integer,
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_create_dbax_defi_grup]
            @P_CODI_GRUP varchar(50), 
            @P_DESC_GRUP varchar(100) 
 AS
 BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_dbax_defi_grup]
(
@tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_read_dbax_defi_segm] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_defi_segm]
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_create_dbax_defi_segm]
            @P_CODI_SEGM varchar(50), 
            @P_DESC_SEGM varchar(100) 
 AS
 BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_defi_segm]
            @P_CODI_SEGM varchar(50) 
 AS
 BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[prc_dbax_proc_homo]
(
	@p_tipo_taxo varchar(10),
...
SET QUOTED_IDENTIFIER ON
GO
CREATE  procedure [dbo].[prc_read_dbax_homo_deta] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_create_dbax_homo_deta]
            @P_CODI_HOCO numeric(22, 0), 
            @P_PREF_CONC varchar(50), 
            @P_CODI_CONC varchar(256), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_homo_deta]
            @P_CODI_HOCO numeric(22, 0), 
            @P_PREF_CONC varchar(50), 
            @P_CODI_CONC varchar(256),  
            @P_PREF_CONC1 varchar(50), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_homo_deta]
            @P_CODI_HOCO numeric(22, 0), 
            @P_PREF_CONC varchar(50), 
            @P_CODI_CONC varchar(256), 
            @P_PREF_CONC1 varchar(50), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_sys_object_create]
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_sys_object_delete]
            @P_OBJECT_NAME VARCHAR(30) 
 AS
 BEGIN
        DELETE 	sys_object
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_sys_object_read] (
 @tsTipo as VARCHAR(4),
 @tnPagina as INTEGER,
 @tnRegPag as INTEGER,
 @tsCondicion as VARCHAR(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_sys_object_update]
            @P_OBJECT_NAME VARCHAR(30), 
            @P_OBJECT_TYPE VARCHAR(1), 
            @P_OBJECT_BRIEF VARCHAR(100), 
            @P_TABLE_NAME VARCHAR(30), 
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_repo_rous_read_busq]
(
	@p_codi_rous varchar(30),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_sys_object]
            @P_OBJECT_NAME varchar(30) 
 AS
 BEGIN
        DELETE sys_object
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_create_rous_menu_furo](
	@P_NOMB_ROUS VARCHAR(30),
	@P_CODI_MODU VARCHAR(30),
	@P_NOMB_MENU VARCHAR(30))
AS
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_rous_menu_categoria_read](
	@P_CODI_ROUS VARCHAR(30),
	@P_CODI_MODU VARCHAR(30),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_rous_menu_furo_create](
	@P_NOMB_ROUS VARCHAR(30),
	@P_CODI_MODU VARCHAR(30),
	@P_NOMB_MENU VARCHAR(30))
AS
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_rous_menu_read](
	@P_CODI_MODU VARCHAR(30),
	@P_CODI_ROUS VARCHAR(30)
)
AS
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_get_modulo_read]
@P_OBJECT_NAME VARCHAR(30)	
AS
BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[prc_create_dbax_proc_even]
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_read_dbax_defi_ramo] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_defi_ramo]
            @P_CODI_SEGM varchar(50), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_defi_ramo]
            @P_CODI_SEGM varchar(50), 
            @P_CODI_RAMO varchar(30),
            @P_TIPO_RAMO varchar(1)
 AS
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_create_dbax_defi_ramo]
           @P_CODI_SEGM varchar(50), 
            @P_CODI_RAMO varchar(30), 
            @P_DESC_RAMO varchar(80), 
            @P_CODI_RAMO_SUPE varchar(30),
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_dbax_ramos]
(
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_ciudad] (
	@tsTipo as Varchar(2),	
	@tnPagina as integer,	
	@tnRegPag as integer, 
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_area_geog_read_pais] (
	@tsTipo as VARCHAR(3),	
	@tnPagina as INTEGER,	
	@tnRegPag as INTEGER, 
	@tsCondicion as VARCHAR(2048),
...
-- Description:	Procedimiento para la obtencion  de las comunas
-- =============================================
CREATE PROCEDURE [dbo].[prc_area_geog_read_comunas] (
	@tsTipo as VARCHAR(3),	
	@tnPagina as INTEGER,	
	@tnRegPag as INTEGER, 
	@tsCondicion as VARCHAR(2048),
...
-- Description:	Procedimiento para la obtencion  de las comunas
-- =============================================
CREATE PROCEDURE [dbo].[prc_area_geog_read_ciudad] (
	@tsTipo as VARCHAR(3),	
	@tnPagina as INTEGER,	
	@tnRegPag as INTEGER, 
	@tsCondicion as VARCHAR(2048),
...
SET QUOTED_IDENTIFIER ON
GO
CREATE function [dbo].[addmonths](@pPeriodo varchar(6), @pMeses numeric(2)) returns datetime
begin
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[SP_AX_getInstDimeVers]
	@pCodiPers	 varchar(16),
	@pCorrInst	 numeric(10,0),
	@pVersInst	 numeric(5,0),
...
BEGIN
	...
	and    corr_inst = @pCorrInst
	and    vers_inst = @pVersInst
	and	   codi_dein = @pCodiInfo
	and    pref_dime = @pPrefDime
	and    codi_dime = @pCodiDime
	and    codi_memb = @pCodiMemb
END
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_delInstDocuVers]    Fecha de la secuencia de comandos: 10/04/2013 16:26:45 ******/
SET ANSI_NULLS ON
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[SP_AX_delInstDocuVers] (@pCodiPers numeric(9,0),@pCorrInst numeric(10,0), @pVersInst numeric(5,0))
AS
BEGIN
	delete from dbax_dife_xbrl where codi_pers = @pCodiPers  and corr_inst = @pCorrInst and vers_inst = @pVersInst
	delete from dbax_inst_dime where codi_pers = @pCodiPers  and corr_inst = @pCorrInst and vers_inst = @pVersInst
	delete from dbax_inst_memb where codi_pers = @pCodiPers  and corr_inst = @pCorrInst and vers_inst = @pVersInst
	delete from dbax_inst_conc where codi_pers = @pCodiPers  and corr_inst = @pCorrInst and vers_inst = @pVersInst
	delete from dbax_inst_arch where codi_pers = @pCodiPers  and corr_inst = @pCorrInst and vers_inst = @pVersInst
	delete from dbax_inst_unit where codi_pers = @pCodiPers  and corr_inst = @pCorrInst and vers_inst = @pVersInst
	delete from dbax_inst_dicx where codi_pers = @pCodiPers  and corr_inst = @pCorrInst and vers_inst = @pVersInst
	delete from dbax_inst_cntx where codi_pers = @pCodiPers  and corr_inst = @pCorrInst and vers_inst = @pVersInst
	delete from dbax_inst_info where codi_pers = @pCodiPers  and corr_inst = @pCorrInst and vers_inst = @pVersInst
	delete from dbax_inst_vers where codi_pers = @pCodiPers  and corr_inst = @pCorrInst and vers_inst = @pVersInst
...
-- Description:	<Description,,>
-- =============================================
CREATE procedure [dbo].[prc_cent_cost_create]
            @P_CODI_EMEX VARCHAR(30), 
            @P_CODI_EMPR numeric(9, 0), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_cent_cost_read] (
 @tsTipo as VARCHAR(3),
 @tnPagina as INTEGER,
 @tnRegPag as INTEGER,
 @tsCondicion as VARCHAR(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_cent_cost_update]
            @P_CODI_EMEX VARCHAR(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_CECO VARCHAR(16), 
            @P_NOMB_CECO VARCHAR(80), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_cent_cost_delete]
            @P_CODI_EMEX VARCHAR(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_CECO VARCHAR(16) 
 AS
...
-- Description:	<Description,,>
-- =============================================
CREATE procedure [dbo].[prc_create_cent_cost]
            @P_CODI_EMEX varchar(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_CECO varchar(16), 
            @P_NOMB_CECO varchar(80), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_cent_cost]
            @P_CODI_EMEX varchar(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_CECO varchar(16) 
 AS
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[SP_AX_getMiembroInstMemb ]
	@p_codi_pers varchar(30),
	@p_corr_inst varchar(10),
	@p_vers_inst varchar(2),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_repo_read] (
	@tsTipo as Varchar(4),	
	@tnPagina as integer,	
	@tnRegPag as integer, 
	@tsCondicion as Varchar(128),
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_repo_create] 
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_repo_delete]
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_colu_create_auto] 
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_repo_update] 
		@P_CODI_REPO VARCHAR(25),			@P_TITU_REPO VARCHAR(128), 
		@P_DESC_REPO VARCHAR(200),			@P_CODI_RESX VARCHAR(30),
		@P_PROC_REPO VARCHAR(30),			@P_CODI_MODU VARCHAR(30),
		@P_SCRP_SQLS TEXT,					@P_SCRP_SQLO TEXT,
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_boto_read](
	@tsTipo as Varchar(4),	
	@tnPagina as integer,	
	@tnRegPag as integer, 
	@tsCondicion as Varchar(128),
...
-- Description:	
-- =============================================
CREATE  procedure [dbo].[prc_read_dbax_desc_conc] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	
-- =============================================
CREATE  procedure [dbo].[prc_read_dbne_defi_lang] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_list_repo] (
...
SET QUOTED_IDENTIFIER ON
GO
CREATE  procedure [dbo].[prc_read_dbax_defi_pers] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_colu_read](
	@tsTipo as Varchar(4),	
	@tnPagina as integer,	
	@tnRegPag as integer, 
	@tsCondicion as Varchar(128),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_mant_list_read]  (
	@tsTipo as Varchar(4),	
	@tnPagina as integer,	
	@tnRegPag as integer, 
	@tsCondicion as Varchar(128),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_read_dbax_defi_peho] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_read_dbax_tipo_conc] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_read_dbax_defi_conc] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_usua_sist_read]  (
	@tsTipo as VARCHAR(3),	
	@tnPagina as INTEGER,	
	@tnRegPag as INTEGER, 
	@tsCondicion as VARCHAR(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_sys_code_read] (
 @tsTipo as VARCHAR(4),
 @tnPagina as INTEGER,
 @tnRegPag as INTEGER,
 @tsCondicion as VARCHAR(2048),
...
-- Description:	<Description,,>
-- =============================================
 CREATE  PROCEDURE [dbo].[prc_sys_domain_read] (
 @tsTipo as VARCHAR(4),
 @tnPagina as INTEGER,
 @tnRegPag as INTEGER,
 @tsCondicion as VARCHAR(2048),
...
SET QUOTED_IDENTIFIER ON
GO
CREATE  procedure [dbo].[prc_read_dbax_taxo_vers] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
BEGIN
 ...
 BEGIN
	...
	select '' as CODIGO, 'Seleccione' as VALOR, 1 orden
	union
	SELECT vers_taxo as CODIGO, desc_taxo as VALOR, 2 orden
	FROM dbax_taxo_vers
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_read_dbax_tipo_taxo] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_repo_rous_read] (
	@tsTipo as Varchar(4),	
	@tnPagina as integer,	
	@tnRegPag as integer, 
	@tsCondicion as Varchar(128),
...
SET QUOTED_IDENTIFIER ON
GO
CREATE  procedure [dbo].[prc_read_dbax_homo_conc] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE procedure [dbo].[prc_read_dbax_info_conc] (
 @tsTipo as Varchar(2),
 @tnPagina as integer,
 @tnRegPag as integer,
 @tsCondicion as Varchar(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_personas_read] (
 @tsTipo as VARCHAR(3),
 @tnPagina as INTEGER,
 @tnRegPag as INTEGER,
 @tsCondicion as VARCHAR(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_empr_exte_read] (
 @tsTipo as VARCHAR(4),
 @tnPagina as INTEGER,
 @tnRegPag as INTEGER,
 @tsCondicion as VARCHAR(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_empr_read]  (
	@tsTipo as VARCHAR(4),	
	@tnPagina as INTEGER,	
	@tnRegPag as INTEGER, 
	@tsCondicion as VARCHAR(2048),
...
SET QUOTED_IDENTIFIER ON
GO
CREATE  procedure [dbo].[prc_sys_usro_read]  (
	@tsTipo as VARCHAR(4),	
	@tnPagina as INTEGER,	
	@tnRegPag as INTEGER, 
	@tsCondicion as VARCHAR(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_lista_lndi_emp] (
	@tsTipo as Varchar(2),	
	@tnPagina as integer,	
	@tnRegPag as integer, 
	@tsCondicion as Varchar(128),
...
BEGIN
	...
	BEGIN
		if(@tsPar1 is null)
		begin
			set @sql = 'SELECT ROW_NUMBER() OVER(ORDER BY dbfe.codi_indi ASC) AS REG, dbfe.codi_indi , dbfe.tipo_conc , dbfe.desc_indi , dbfe.form_indi from dbax_form_enca dbfe where ((dbfe.codi_emex = ''0'' and dbfe.codi_empr = ''0'') or (dbfe.codi_emex = '''+@p_codi_emex+''' and dbfe.codi_empr = ''' + str(@p_codi_empr) + ''')) '
		end
		else
		begin
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_usua_empr_read] (
 @tsTipo as VARCHAR(4),
 @tnPagina as INTEGER,
 @tnRegPag as INTEGER,
 @tsCondicion as VARCHAR(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_ofic_empr_read] (
 @tsTipo as VARCHAR(3),
 @tnPagina as INTEGER,
 @tnRegPag as INTEGER,
 @tsCondicion as VARCHAR(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_para_empr_read] (
 @tsTipo as VARCHAR(4),
 @tnPagina as INTEGER,
 @tnRegPag as INTEGER,
...
BEGIN
	...
	from	dbax_defi_cntx dc
	where	((codi_emex = '0' and codi_empr = 0) or (codi_emex = @CodiEmex and codi_empr = @CodiEmpr))
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_boto_update]
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_boto_create] 
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_boto_delete]
(@P_CODI_REPO varchar(30),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_colu_delete]
(@P_CODI_REPO varchar(20),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_colu_create] 
		@P_CODI_REPO VARCHAR(25),			
		@P_CODI_COLU VARCHAR(15), 
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_list_colu_update] 
		@P_CODI_REPO VARCHAR(25),			
		@P_CODI_COLU VARCHAR(15), 
		@P_NOMB_COLU VARCHAR(30),			
		@P_DESC_COLU VARCHAR(128),
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_dbax_cuadros]
AS
BEGIN
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_dbax_dimensiones] 
	@P_CODI_DEIN VARCHAR(128)
AS
BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_repo_rous_create]
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_dbn_repo_rous_delete]
@P_CODI_REPO varchar(30),
@P_CODI_MODU varchar(30),
@P_CODI_ROUS VARCHAR(30)
AS
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_tipo_conc]
...
-- Description:	<Description,,>
-- =============================================
create  procedure [dbo].[prc_create_dbax_tipo_conc]
            @P_TIPO_CONC varchar(20), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_tipo_conc]
            @P_TIPO_CONC varchar(20), 
            @P_DESC_CONC varchar(100), 
            @P_TIPO_ELEM nchar 
 AS
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[SP_AX_GetConcPorTaxonomia](
	@p_CodiEmex	varchar(30),
	@p_CodiEmpr numeric(9,0),
	@p_VersTaxo  varchar(50),
	@p_DescConc  varchar(100),
	@p_CodiInfo	 varchar(50),
	@p_OrdeConc	 varchar(5),
	@p_PrefConc	 varchar(50),
	@p_CodiConc  varchar(256),
	@p_TipoTaxo  varchar(10)='') as
BEGIN
--La mayoria de los parametros son opciones, pero si se ingresa un prefijo la 
--busqueda del concepto será exacta por pref_conc + codi_conc

	declare @ComoConc varchar(2)
	declare @ComoInfo varchar(2)
	...
	select	distinct
			'[' + di.desc_info + '] [' + convert(varchar,ic.orde_conc) + '] ' + replicate(' ',ic.nive_conc) + sc.desc_conc + ' (' + cast(dc.pref_conc as varchar(12)) collate Modern_Spanish_CS_AS + ')' as desc_conc,
			dc.pref_conc as pref_conc, 
			dc.codi_conc as codi_conc,
			ic.codi_info,
			ic.orde_conc  
	...
	where	(dc.pref_conc = sc.pref_conc 
			and		dc.codi_conc = sc.codi_conc 
			and		dc.tipo_conc = tc.tipo_conc 
			and		upper(sc.desc_conc  + ' (' + cast(dc.pref_conc as varchar(12)) collate Modern_Spanish_CS_AS + ')') like upper('%' + @p_DescConc + '%')
			and		dc.pref_conc like @ComoConc + @p_PrefConc + @ComoConc
			and		dc.codi_conc like @ComoConc + @p_CodiConc + @ComoConc
			and		s.domain_code in ('200','210')
			and		dc.tipo_valo = s.code
			and		dc.pref_conc != 'indi'
			and		dc.tipo_taxo like '%' + @p_TipoTaxo + '%'
			...
			and		((ic.codi_emex = '0' and ic.codi_empr = 0) or (ic.codi_emex = @p_CodiEmex and ic.codi_empr = @p_CodiEmpr))
			and		ic.codi_info like @ComoInfo + @p_CodiInfo + @ComoInfo
			and		ic.pref_conc = dc.pref_conc
			and		ic.codi_conc = dc.codi_conc
			and		ic.orde_conc like @ComoInfo + @p_OrdeConc + @ComoInfo
			and		id.codi_emex = ic.codi_emex
			and		id.codi_empr = ic.codi_empr
			and		id.codi_info = ic.codi_info
			and		id.tipo_info = 'C'
			and		id.indi_vige = '1'
			and		di.codi_emex = id.codi_emex
			and		di.codi_empr = id.codi_empr
			and		di.codi_info = id.codi_info
			and		di.codi_lang = 'codi_cort'
			and		di.tipo_info = id.tipo_info)
	or
			(dc.pref_conc = sc.pref_conc 
			and		dc.codi_conc = sc.codi_conc 
			and		dc.tipo_conc = tc.tipo_conc 
			--and		upper(sc.desc_conc  + ' (' + cast(dc.pref_conc as varchar(12)) collate Modern_Spanish_CS_AS + ')') like upper('%' + @p_DescConc + '%')
			and		dc.pref_conc like @ComoConc + @p_PrefConc + @ComoConc
			...
			and		di.codi_lang = 'codi_cort'
			and		di.tipo_info = id.tipo_info
			and		di.desc_info like '%' + @p_DescConc + '%')
	order by ic.codi_info, ic.orde_conc, desc_conc ASC
END
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getConcepInfo]    Fecha de la secuencia de comandos: 10/04/2013 16:26:49 ******/
SET ANSI_NULLS ON
...
BEGIN
	...
	begin
	   select	A.pref_conc,
				D.codi_conc,
				A.orde_conc,
				replicate('&nbsp;',A.nive_conc) +  D.desc_conc as desc_conc, 
				A.nive_conc,
				A.negr_conc,
				CASE 
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_create_exec_bin]
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[SP_AX_COMPANIA](@pTipoPers varchar(1), @pRuttPers varchar(16), @pNombPers varchar(100), @pNfanPers varchar(50)) as
begin
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_defi_peho]
            @P_CODI_EMEX varchar(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_PERS numeric(9, 0), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_create_dbax_defi_peho]
            @P_CODI_EMEX varchar(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_PERS varchar(16), 
            @P_DESC_EMPR varchar(200) 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_defi_peho]
            @P_CODI_PERS numeric(9, 0), 
            @P_CODI_EMEX varchar(30), 
            @P_CODI_EMPR numeric(9, 0) 
 AS
...
-- Description:	
-- =============================================
create  procedure [dbo].[prc_create_dbne_defi_lang]
...
-- Description:	
-- =============================================
CREATE  procedure [dbo].[prc_update_dbne_defi_lang]
            @P_CODI_LANG varchar(50), 
            @P_DESC_LANG varchar(100) 
 AS
 BEGIN
...
-- Description:	
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbne_defi_lang]
            @P_CODI_LANG varchar(50) 
 AS
 BEGIN
...
AS
BEGIN
	insert into dbax_info_defi (codi_emex, codi_empr, codi_info, tipo_taxo, indi_vige)
			values (@CodiEmex, @CodiEmpr, @CodiInfo, @Tipotaxo, @IndiVige)
	...
	insert into dbax_desc_info (codi_emex, codi_empr, codi_info, codi_lang, desc_info)
			values (@CodiEmex,@CodiEmpr,@CodiInfo,'codi_cort',@CodiCort)
END
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_delInfoDefi]    Fecha de la secuencia de comandos: 10/04/2013 16:26:45 ******/
SET ANSI_NULLS ON
...
SET QUOTED_IDENTIFIER ON
GO
CREATE function [dbo].[AX_getDescInfo](
			@p_CodiEmex varchar(30),
			@p_CodiEmpr numeric(9,0),
			@p_CodiInfo varchar(50),
			@p_CodiLang varchar(256)='es_ES',
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_para_empr_create]
            @P_CODI_EMPR numeric(9, 0), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_para_empr_update]
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_PAEM VARCHAR(30), 
            @P_TIPO_COMO VARCHAR(3), 
            @P_DESC_PAEM VARCHAR(200), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_para_empr_delete]
            @P_CODI_EMPR numeric(9, 0), 
            @P_TIPO_COMO VARCHAR(3), 
            @P_CODI_PAEM VARCHAR(30),
            @P_CODI_EMEX VARCHAR(30)
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_ofic_empr_update]
            @P_CODI_EMEX VARCHAR(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_OFIC VARCHAR(3), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_ofic_empr_delete]
            @P_CODI_EMEX VARCHAR(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_OFIC VARCHAR(3) 
 AS
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_ofic_empr_create]
            @P_CODI_EMEX VARCHAR(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_OFIC VARCHAR(3), 
            @P_DESC_OFIC VARCHAR(30), 
...
SET QUOTED_IDENTIFIER ON
GO
CREATE  procedure [dbo].[prc_sys_usro_update]
            @P_CODI_ROUS VARCHAR(30), 
            @p_codi_usua VARCHAR(30), 
            @P_CODI_MODU VARCHAR(30) 
 AS
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_get_rol_read] 
	@p_codi_usua VARCHAR(30)
AS
BEGIN
	select codi_rous 
...
SET QUOTED_IDENTIFIER ON
GO
CREATE  procedure [dbo].[prc_sys_usro_delete]
            @p_codi_usua VARCHAR(30), 
            @P_CODI_MODU VARCHAR(30),
            @P_CODI_ROUS VARCHAR(30)
 AS
...
SET QUOTED_IDENTIFIER ON
GO
create  procedure [dbo].[prc_sys_usro_create]
            @P_CODI_ROUS VARCHAR(30), 
            @P_CODI_USUA VARCHAR(30), 
            @P_CODI_MODU VARCHAR(30) 
 AS
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[prc_read_codi_conc]
(
	@tsTipo as Varchar(2),	
	@tnPagina as integer,	
	@tnRegPag as integer, 
...
-- Description:	
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_desc_conc]
            @P_CODI_CONC varchar(256), 
            @P_CODI_LANG varchar(50), 
            @P_PREF_CONC varchar(50) 
 AS
...
-- Description:	
-- =============================================
create  procedure [dbo].[prc_create_dbax_desc_conc]
            @P_PREF_CONC varchar(50), 
            @P_CODI_CONC varchar(256), 
            @P_CODI_LANG varchar(50), 
...
-- Description:	
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_desc_conc]
            @P_PREF_CONC varchar(50), 
            @P_CODI_CONC varchar(256), 
            @P_CODI_LANG varchar(50), 
            @P_DESC_CONC varchar(512) 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_empr_exte_create]
            @P_CODI_EMEX VARCHAR(30), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_empr_exte_delete]
            @P_CODI_EMEX VARCHAR(30) 
 AS
 BEGIN
        DELETE empr_exte
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_empr_exte_update]
@P_CODI_EMEX VARCHAR(30), 
            @P_NOMB_EMEX VARCHAR(80), 
            @P_STAT_EMEX VARCHAR(1), 
            @P_FEIN_EMEX datetime, 
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_AX_getCodigosEmpresa]
	@p_corr_inst varchar(16)
AS
BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_tipo_taxo]
            @P_TIPO_TAXO varchar(10) 
 AS
 BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_create_dbax_tipo_taxo]
            @P_TIPO_TAXO varchar(10), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_tipo_taxo]
            @P_TIPO_TAXO varchar(10), 
            @P_DESC_TIPO varchar(50) 
 AS
 BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_defi_pers]
            @P_CODI_PERS numeric(9, 0), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_create_dbax_defi_pers]
            @P_CODI_PERS varchar(16), 
            @P_DESC_PERS varchar(100), 
            @P_CODI_GRUP varchar(50), 
            @P_CODI_SEGM varchar(50), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_defi_pers]
            @P_CODI_PERS numeric(9, 0) 
 AS
 BEGIN
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_AX_getInfoDefi]
(
	@p_codi_emex varchar(30),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_vali_usua_read]
@p_codi_usua VARCHAR(30)
AS
BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE procedure [dbo].[prc_usua_sist_update]
            @p_codi_usua VARCHAR(30), 
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_list_valo](
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_usua_sist_delete]
(
@p_codi_usua VARCHAR(30),
@P_CODI_EMEX VARCHAR(30),
@P_CODI_EMPR numeric(9,0)
...
-- =============================================
-- Author:	<Author,,Aaron Rojas>
-- Create date: <Create Date,,2012-10-01>
-- Description:	Procedimiento para Insertar Nuevos Usuarios de Sistema
-- =============================================
CREATE  procedure [dbo].[prc_usua_sist_create]
            @p_codi_usua VARCHAR(30), 
            @P_NOMB_USUA VARCHAR(80), 
            @P_CODI_PERS VARCHAR(16), 
            @P_CODI_ROUS VARCHAR(30), 
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_usua_cadu_update]
@p_codi_usua VARCHAR(30),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_pass_usua_update]
(@p_codi_usua VARCHAR(30),
@P_DIAS_VIGE INT,
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_fech_vige_usua_read]
@p_codi_usua VARCHAR(30)
AS
BEGIN
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_usua_esta_update]
@p_codi_usua VARCHAR(30),
@P_USUA_ESTA VARCHAR(1)
AS
BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_usua_esta_read]
	@p_codi_usua VARCHAR(30)
AS
BEGIN
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_erro_logi_update]
@p_codi_usua VARCHAR(30)
AS
BEGIN
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_erro_logi_read]
@p_codi_usua VARCHAR(30)
AS
BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_fech_vige_read]
@p_codi_usua VARCHAR(30)
AS
BEGIN
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_erro_logi2_update]
@p_codi_usua VARCHAR(30)
AS
BEGIN
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_code_categoria]
AS
BEGIN
	SELECT '' as CODIGO, 'Seleccione' as VALOR
	union
...
-- Description:	Procedimiento que obtiene las categorias para los listadores
-- =============================================
CREATE PROCEDURE [dbo].[prc_cate_repo_read]
AS
BEGIN
	SELECT '' as CODIGO, 'Seleccione' as VALOR
	union
...
-- Description:	<Description,,>
-- =============================================
create  procedure [dbo].[prc_sys_code_create]
            @P_CODE VARCHAR(12), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_sys_code_delete]
            @P_DOMAIN_CODE numeric(4, 0), 
            @P_CODE VARCHAR(12) 
 AS
 BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_sys_code_update]
            @P_CODE VARCHAR(12), 
            @P_CODE_DESC VARCHAR(50), 
            @P_DOMAIN_CODE numeric(4, 0), 
            @P_CODE_AUX VARCHAR(30), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_usua_empr_update]
            @p_codi_usua VARCHAR(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_OFIC VARCHAR(3) 
 AS
...
-- Description:	<Description,,>
-- =============================================
create  procedure [dbo].[prc_usua_empr_create]
            @P_CODI_USUA VARCHAR(30), 
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_OFIC VARCHAR(3) 
 AS
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_usua_empr_delete]
            @P_CODI_EMPR numeric(9, 0), 
            @p_codi_usua VARCHAR(30) 
 AS
 BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE  PROCEDURE [dbo].[prc_sys_domain_delete]
            @P_DOMAIN_CODE numeric(4, 0) 
 AS
 BEGIN
        DELETE sys_domain
...
-- Description:	<Description,,>
-- =============================================
CREATE  PROCEDURE [dbo].[prc_sys_domain_create]
            @P_DOMAIN_CODE numeric(4, 0), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  PROCEDURE [dbo].[prc_sys_domain_update]
            @P_DOMAIN_CODE numeric(4, 0), 
            @P_DOMAIN_NAME VARCHAR(20), 
            @P_DOMAIN_LENGTH numeric(2, 0), 
            @P_DOMAIN_TYPE VARCHAR(1), 
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_furo_menu_rol]
(
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_furo_delete] (
	@P_CODI_MODU VARCHAR(30),
	@P_CODI_ROUS VARCHAR(30)
)
AS
...
-- Description:	<Description,,>
-- =============================================
create  procedure [dbo].[prc_create_dbax_defi_conc]
            @P_PREF_CONC varchar(50), 
            @P_CODI_CONC varchar(256), 
            @P_TIPO_CONC varchar(20), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_defi_conc]
            @P_PREF_CONC varchar(50), 
            @P_CODI_CONC varchar(256), 
            @P_TIPO_CONC varchar(20), 
            @P_TIPO_PERI varchar(15), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_defi_conc]
            @P_CODI_CONC varchar(256), 
            @P_PREF_CONC varchar(50) 
 AS
 BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_personas_create]
            @P_CODI_EMEX VARCHAR(30), 
            @P_CODI_PERS VARCHAR(16), 
...
-- Description:	<Description,,>
-- =============================================
CREATE procedure [dbo].[prc_personas_update]
            @P_CODI_EMEX VARCHAR(30), 
            @P_CODI_PERS VARCHAR(16), 
            @P_NOMB_PERS VARCHAR(80), 
            @P_RUTT_PERS numeric(9, 0), 
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_pref_conc]
(
	 @tsTipo as Varchar(2),
	 @tnPagina as integer,
	 @tnRegPag as integer,
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[SP_AX_insInstDicx] (
		@pCodiPers numeric(9,0),@pCorrInst numeric(10,0), 
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_pref_taxo]
(
	@tsTipo as Varchar(2),
	 @tnPagina as integer,
	 @tnRegPag as integer,
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_create_dbax_taxo_vers]
            @P_VERS_TAXO varchar(256), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_taxo_vers]
            @P_VERS_TAXO varchar(256) 
 AS
 BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_taxo_vers]
            @P_VERS_TAXO varchar(256), 
            @P_UBIC_TAXO varchar(256), 
            @P_TIPO_TAXO varchar(4) 
 AS
...
-- Description:	<Description,,>
-- =============================================
CREATE function [dbo].[dbnet_get_empr]  () returns numeric(4) as
begin
...
-- Description:	<Description,,>
-- =============================================
CREATE function [dbo].[dbnet_get_pers] () returns varchar  as
begin
...
-- Description:	<Description,,>
-- =============================================
CREATE function [dbo].[dbnet_get_modu] () returns varchar  as
begin
...
-- Description:	<Description,,>
-- =============================================
CREATE function [dbo].[dbnet_get_rous] () returns varchar  as
begin
  declare @p_codi_rous varchar(30)
...
-- Description:	<Description,,>
-- =============================================
CREATE function [dbo].[dbnet_get_usua] () returns varchar(30)  as
begin
...
-- Description:	<Description,,>
-- =============================================
CREATE function [dbo].[dbnet_get_emex] ()  returns varchar(30)  as
begin
...
-- Description:	<Description,,>
-- =============================================
CREATE function [dbo].[dbnet_get_cult] () returns varchar  as
begin
...
-- =============================================
CREATE FUNCTION [dbo].[fnc_valida_privilegios]
(	
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_sesion_update_fete]
	@p_corr_sess int,
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_create_dbax_info_conc]
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_EMEX varchar(30), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_delete_dbax_info_conc]
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_EMEX varchar(30), 
            @P_CODI_INFO varchar(50), 
            @P_PREF_CONC varchar(50), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_update_dbax_info_conc]
            @P_CODI_EMPR numeric(9, 0), 
            @P_CODI_EMEX varchar(30), 
            @P_CODI_INFO varchar(50), 
            @P_PREF_CONC varchar(50), 
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_pass_repe_read]
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_usua_sist_event_cor_create]
@p_corr_sess decimal,
@p_codi_usua VARCHAR(30),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_usua_sist_event_inf_create] 
	(@p_codi_usua VARCHAR(30),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_usua_sist_event_create_inf] 
	(@p_codi_usua VARCHAR(30),
	@P_CODI_EVEN VARCHAR(4),
	@P_FECH_EVEN DATETIME,
	@P_INFO_EVEN VARCHAR(128))
...
-- Description:	Procedimiento que registra la conexion a la aplicacion, correlativo de session, codigo_usuario, codigo de evento, fecha del evento
-- =============================================
CREATE PROCEDURE [dbo].[prc_usua_sist_event_create_cor]
@p_corr_sess decimal,
@p_codi_usua VARCHAR(30),
@p_codi_even VARCHAR(30),
@p_fech_even VARCHAR(30)
...
-- Description:	Procedimiento que registra la conexion a la aplicacion, correlativo de session, codigo_usuario, codigo de evento, fecha del evento
-- =============================================
CREATE PROCEDURE [dbo].[prc_usua_sist_event_create]
@p_codi_usua VARCHAR(30),
@p_codi_even VARCHAR(30),
@p_fech_even VARCHAR(30)
AS
...
SET QUOTED_IDENTIFIER ON
GO
CREATE function [dbo].[FU_AX_getMoneda](
			@p_codi_pers numeric(10), 
			@p_corr_inst numeric(5), 
			@p_vers_inst numeric(5)
            ) 
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_AX_getTipoMone]
(
	@p_codi_pers varchar(30),
	@p_corr_inst varchar(30)
)
...
-- Description:	<Description,,>
-- =============================================
CREATE procedure [dbo].[prc_empr_delete]
            @P_CODI_EMPR numeric 
 AS
 BEGIN
        DELETE empr
...
-- Description:	<Description,,>
-- =============================================
CREATE procedure [dbo].[prc_empr_update]
            @P_CODI_EMPR numeric, 
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_mens_erro_create] 
	(
		@p_codi_erro INTEGER,
...
-- Description:	Procedimiento que inserta los errores de SQL en la BD
-- =============================================
CREATE PROCEDURE [dbo].[prc_mens_erro] 
	(
		@p_codi_erro int,
		@p_mens_erro varchar(4000),
		@p_line_erro varchar(256), 
...
BEGIN
	...
	select	distinct id.codi_info, 
			'[' + dbo.AX_getDescInfo (id.codi_emex,id.codi_empr,id.codi_info, 'codi_cort', id.tipo_info) + '] ' + dbo.AX_getDescInfo (id.codi_emex,id.codi_empr,id.codi_info, 'es_ES', id.tipo_info) + case id.codi_emex when '0' then '*' else '' end as desc_info,
			dbo.AX_getDescInfo (id.codi_emex,id.codi_empr,id.codi_info, 'codi_cort', id.tipo_info) as codi_cort,
			id.tipo_taxo,
			tt.desc_tipo,
			id.orde_info,
			id.indi_vige,
	...
	and		id.tipo_taxo like @vComodinTipo + @pTipoTaxo + @vComodinTipo
	order by id.indi_vige desc, id.orde_info
END
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInformesUsables]    Fecha de la secuencia de comandos: 10/04/2013 16:26:56 ******/
SET ANSI_NULLS ON
...
BEGIN
	...
	begin
		select	distinct id.codi_info + '|' + id.tipo_info collate Modern_Spanish_CS_AS  as codi_info, 
			    '[' + dbo.AX_getDescInfo (id.codi_emex,id.codi_empr,id.codi_info, 'codi_cort',id.tipo_info) + '] ' + dbo.AX_getDescInfo (id.codi_emex,id.codi_empr,id.codi_info, 'es_ES',id.tipo_info)  + case id.codi_emex when '0' then '*' else '' end as desc_info,
			    id.tipo_info,
			    id.orde_info
		from	dbax_info_defi id,
				dbax_desc_info di,
				dbax_inst_info ii
		where	((id.codi_emex = 0 and		id.codi_empr = 0) or (id.codi_emex = @pCodiEmex and	id.codi_empr = @pCodiEmpr))
		and		di.codi_info = id.codi_info
		and		di.codi_lang = 'es_ES'
		and		ii.codi_pers = @pCodiPers
		and		ii.corr_inst = @pCorrInst
		and		ii.vers_inst = @pVersInst
		and		ii.codi_info = id.codi_info
		and     (id.tipo_info='C' or id.tipo_info='D')
		--group by id.codi_info, di.desc_info, id.orde_info,id.tipo_info
		order by id.orde_info
	end
	else
	begin
		...
		and		((id.codi_emex = 0 and id.codi_empr = 0) or (id.codi_emex = @pCodiEmex and id.codi_empr = @pCodiEmpr))
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[prc_dbax_calc_actu]
(
	@p_codi_emex varchar(30),
	@p_codi_empr numeric(9),
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[prc_dbax_inse_data_hira]
(
	@p_codi_pers VARCHAR(16),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_param_create] 
...
SET QUOTED_IDENTIFIER ON
GO
CREATE function [dbo].[separaMiles] (@p_valor varchar(8000)) returns varchar(8000)
as
begin
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_param_read]  (
	@tsTipo as VARCHAR(4),	
	@tnPagina as INTEGER,	
	@tnRegPag as INTEGER, 
	@tsCondicion as VARCHAR(2048),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_param_delete] 
@p_param_name VARCHAR(30)
AS
BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_param_update] 
@P_PARAM_NAME VARCHAR(30),
@P_PARAM_VALUE VARCHAR(100), 
@P_PARAM_DESC VARCHAR(200)
AS
...
SET QUOTED_IDENTIFIER ON
GO
CREATE function [dbo].[separaMilesMone] (	@p_valo_loca varchar(8000), 
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_priv_logi_read]
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_rous_read]  (
	@tsTipo as VARCHAR(4),	
	@tnPagina as INTEGER,	
	@tnRegPag as INTEGER, 
	@tsCondicion as VARCHAR(128),
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[prc_sys_module_read] (
	@tsTipo as VARCHAR(4),	
	@tnPagina as INTEGER,	
	@tnRegPag as INTEGER, 
	@tsCondicion as VARCHAR(2048),
...
BEGIN
	...
	begin
		...
		from	dbax_defi_cntx dc
				...
				and	((ic.codi_emex = 0 and ic.codi_empr = 0) or (ic.codi_emex = @pCodiEmex and ic.codi_empr = @pCodiEmpr))
		where	((dc.codi_emex = 0 and	dc.codi_empr = 0) or (dc.codi_emex = @pCodiEmex and dc.codi_empr = @pCodiEmpr))
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[dbnet_message] 
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_dbax_empresa]
(
	@p_corr_inst varchar(10),
...
-- Description:	<Description,,>
-- =============================================
CREATE procedure [dbo].[prc_empr_create]
            (
 ...
 BEGIN
	...
	BEGIN TRY
		...
		set @P_CODI_ERRO = '1';
		set @P_MENS_ERRO = 'Usted no cuenta con los privilegios para realizar esta acción';
		execute prc_mens_erro_create @P_CODI_ERRO, @P_MENS_ERRO, @p_line_erro, @p_prcc_erro, @P_CORR_SESS
    END TRY
    BEGIN CATCH
		SELECT @P_CODI_ERRO = ERROR_NUMBER();		SELECT @p_mens_erro1 = ERROR_MESSAGE();
		SELECT @p_line_erro = ERROR_LINE();			SELECT @p_prcc_erro = ERROR_PROCEDURE();
		execute prc_mens_erro_create @P_CODI_ERRO, @p_mens_erro1, @p_line_erro, @p_prcc_erro, @P_CORR_SESS
		set @P_MENS_ERRO = '';
    END CATCH
 END;
GO
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[dbnet_init_sess]
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_sys_rous_create]
            @P_CODI_ROUS VARCHAR(30), 
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_sys_rous_delete]
            @P_CODI_ROUS VARCHAR(30) 
 AS
 BEGIN
        DELETE sys_rous
...
-- Description:	<Description,,>
-- =============================================
CREATE  procedure [dbo].[prc_sys_rous_update]
            @P_CODI_ROUS VARCHAR(30), 
            @P_DESC_ROUS VARCHAR(100), 
            @P_SENT_ROUS VARCHAR(2000),
            @P_CODI_MODU VARCHAR(30) 
...
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[prc_dbax_inst_conc_conv_mone]
(
	@p_codi_pers VARCHAR(16),
	@p_corr_inst NUMERIC(10,0),
	@p_vers_inst NUMERIC(5,0),
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_read_dbax_getValorColumnaRamo]
(
	@p_codi_pers varchar(30),
	@p_corr_inst numeric(10,0),
	@p_vers_inst varchar(2), 
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[SP_AX_getValoresPorInfoDimeCntx]
	@pCodiPers	 varchar(16),
	@pCorrInst	 numeric(10,0),
	@pVersInst	 numeric(5,0),
	...
	@pPrefDime varchar(50),
	@pCodiDime varchar(256),
	@pCodiMone varchar(30) = 'MONE_LOCA'
as
BEGIN
	select	case @pCodiMone 
	...
	group by ic.corr_conc, ic.pref_conc, ic.codi_conc, dc.orde_conc
	order by orde_conc
END
GO
/****** Objeto:  StoredProcedure [dbo].[SP_AX_getInfoValoColu]    Fecha de la secuencia de comandos: 10/04/2013 16:26:56 ******/
...
GO
--Galdamez
CREATE PROCEDURE [dbo].[prc_calc_mone_all]
	@p_corr_inst varchar(16)
AS
BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE procedure [dbo].[dbnet_context]
@p_codi_usua varchar(30) ,
