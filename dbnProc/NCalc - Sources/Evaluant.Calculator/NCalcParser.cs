			...
			switch (alt20)
			{
                case 1:
                    ...
                    // C:\\Users\\sebros\\My Projects\\NCalc\\Grammar\\NCalc.g:208:5: INTEGER
                    {
                        ...
                        try
                        {
                            retval.value = new ValueExpression(Int64.Parse((INTEGER35 != null ? INTEGER35.Text : null)));
                        }
                        catch (System.OverflowException)
                        {
                            retval.value = new ValueExpression(float.Parse((INTEGER35 != null ? INTEGER35.Text : null)));
                        }
