<%@ page title="" language="C#" masterpagefile="~/dbnet.dbax/MasterPage.master" autoeventwireup="true" inherits="PlantillasXbrl, App_Web_plantillasxbrl.aspx.95992650" maintainscrollpositiononpostback="true" enableeventvalidation="false" %>
          ...
          <asp:GridView ID="Grilla_informe" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Negrita">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="negrita" runat="server" Enabled ="false"/>
                                    </ItemTemplate>
                                    <EditItemTemplate>
